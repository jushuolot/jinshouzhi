...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四九，第九日拌嘴。探照灯撕开雨后泥气——资料室重开，先把王墩和金牙刘的口供按层位转写。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别顺手揣兜里，也别说这是花椒罐！"], artifactHint: 3 },
      ...
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇四九，超越期第九日。门后风带着铜锈味——新坑编号比人间论文快一代，连营地拌嘴都有时间戳。"], artifactHint: 0 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇四九第九日，胖爷第一铲给它，第二铲留着埋刘哥的歪理！"], artifactHint: 2 },
