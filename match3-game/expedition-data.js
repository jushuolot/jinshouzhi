...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨夜营地", level: 0, x: -3.5, z: 2.2, discover: ["narrator", "广汉平原，探照灯撕开雨幕。文明历二〇三三的田野笔记刚烘干，第一层探方，从这里下。"], artifactHint: 3 },
      ...
      },
      {
        nodes: [
          ...
          { id: "c1n1", name: "封土区", level: 24, x: -1.8, z: 0.5, discover: ["yangxue", "封土层！七八号坑编号在这里对上了，消除相邻文物等于震土，也等于补一行二〇三三记录。"], artifactHint: 3 },
      ...
      },
      {
        nodes: [
          ...
          { id: "c2n3", name: "九枝叉", level: 54, x: 1.5, z: -1.5, discover: ["yangxue", "九枝九鸟，与《山海经》互文。复兴期二〇三三的枝序表，今晚终于不用猜第三枝了。"], artifactHint: 5 },
      ...
      },
      {
        nodes: [
          ...
          { id: "c4n4", name: "续字前庭", level: 98, x: 2.9, z: -2.8, discover: ["narrator", "墙上只有一个字：续。王墩困得直点头，符号却像刚睡醒，亮给二〇三三的他们看。"], artifactHint: 2 },
