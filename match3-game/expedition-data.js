...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨夜营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。探照灯撕开雨幕——新坑水汽还在，层位照样记。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！早饭素点没事，手劲不能素。"], artifactHint: 3 },
          { id: "c0n2", name: "象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！二〇四七新坑编号先贴上，别急着讨论它从哪条水路来。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！这回我手套都戴三层了，别扣我新坑诚信分。"], artifactHint: 1 },
          { id: "c0n4", name: "祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是祭祀面，二〇四七的快进层位更不能乱。"], artifactHint: 0 },
          { id: "c0n5", name: "青铜门墓", level: 19, isTomb: true, discover: ["chenli", "门缝里有光。I 级大墓——青铜门启。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇四七，超越期第八日。门后风带着铜锈味——层位图比人间论文又快两年。"], artifactHint: 0 },
