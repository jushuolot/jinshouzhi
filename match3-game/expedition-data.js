...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后新坑", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。小雨停了，探照灯照出新坑边线——造物主不在屏前，层位照样记。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片晨层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷第一铲下去——陶片！成片的！刘哥你别顺手揣兜里，二〇四七的袋签都写好了！"], artifactHint: 3 },
          { id: "c0n2", name: "象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！古蜀不产象，今天这批按新坑资料包编号，先拍照再进 Commons 对照表。"], artifactHint: 4 },
      ...
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇四七，超越期第八日。门后风带着铜锈味——层位图比人间论文快到需要晨会重排。"], artifactHint: 0 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇四七第八日，胖爷早饭前又抢到第一铲！"], artifactHint: 2 },
