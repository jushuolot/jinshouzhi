...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "晨雾营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。探照灯切开晨雾——昨夜刚复盘，今天新坑照样记。"], artifactHint: 3 },
          { id: "c0n1", name: "浅灰陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别把样本袋当早点袋！"], artifactHint: 3 },
          { id: "c0n2", name: "湿土象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！湿度比昨夜高，新坑灰线要和二〇四七层位眼镜同步。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉晨纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，咖啡账还没算呢！"], artifactHint: 1 },
          { id: "c0n4", name: "新坑祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是祭祀面，文明历二〇四七的新坑线不能乱。"], artifactHint: 0 },
