...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇五三，第十一日馋嘴日。探照灯撕开回潮的雨泥——资料室重开，营地炊烟从第一铲重新记。"], artifactHint: 3 },
          ...
          { id: "c0n4", name: "祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是祭祀面，层位不能乱，锅气和坑壁声都得分开记。"], artifactHint: 0 },
          { id: "c0n5", name: "青铜门墓", level: 19, isTomb: true, discover: ["chenli", "门缝里有光，炊烟湿度贴也亮了。I 级大墓——青铜门启。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇五三，超越期第十一日。门后风带着铜锈和热汤味——营地记录比人间论文快一代。"], artifactHint: 0 },
          { id: "c1n1", name: "封土区", level: 24, x: -1.8, z: 0.5, discover: ["yangxue", "封土层！消除相邻文物等于震土，但二〇五三模型提醒：先扣掉灶火潮气误差。"], artifactHint: 3 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇五三第十一日，胖爷少贫嘴，第一铲先把汤碗放稳！"], artifactHint: 2 },
          { id: "c2n1", name: "树腰洞", level: 44, x: -1.5, z: 1, discover: ["hutan", "树腰有榫眼。古蜀人插真枝于此，二〇五三的罗盘说它还在长，也在闻营地灶烟。"], artifactHint: 2 },
