...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后新营", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。探照灯撕开雨后的薄雾——周一下新坑，层位照样比人间快两年。"], artifactHint: 3 },
          { id: "c0n1", name: "新坑陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别顺手揣兜里，今天先揣编号牌！"], artifactHint: 3 },
          { id: "c0n2", name: "象牙水路", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！2047 新坑表把纹路判成水路，古蜀不产象，却把远方带进了祭祀坑。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉晨线", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，糊粥的锅还没刷呢！"], artifactHint: 1 },
      ...
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇四七，超越期第八日。门后风带着铜锈味——金面与纵目数据已经提前合表。"], artifactHint: 0 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇四七第八日，胖爷下新坑第一铲先给树根！"], artifactHint: 2 },
