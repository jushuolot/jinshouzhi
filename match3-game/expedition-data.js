...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后新坑", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，宇宙第八日。探照灯撕开雨后雾气——新坑红线北移半尺，层位照样从一号牌记起。"], artifactHint: 3 },
          { id: "c0n1", name: "新陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别顺手揣兜里，今天新坑第一包归档！"], artifactHint: 3 },
          { id: "c0n2", name: "湿象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰被雨水洗亮了。古蜀不产象，二〇四七的新坑索引把这条水路补上了。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉新纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，探方牌刚才是你举反的！"], artifactHint: 1 },
          { id: "c0n4", name: "新祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是新祭祀面，红线往北半尺后，金声更像在催工。"], artifactHint: 0 },
          { id: "c0n5", name: "青铜门墓", level: 19, isTomb: true, discover: ["chenli", "门缝里有光。I 级大墓——青铜门启。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇四七，宇宙第八日。门后风带着铜锈味——层位图比人间论文快一整代。"], artifactHint: 0 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇四七第八日，胖爷打着哈欠也能认出新坑根层！"], artifactHint: 2 },
