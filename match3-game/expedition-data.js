...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇五三，第十一日馋嘴生活日。探照灯撕开雨后泥气——资料室重开，第一铲先和灶火补给单一起记。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别把二〇五三补给签贴泡面盖上！"], artifactHint: 3 },
          { id: "c0n2", name: "象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！古蜀不产象，这是远路来的；今天连运输和食物配给也要写进生活复原。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，二〇五三的生活档案不能把泡面债也写进去吧？"], artifactHint: 1 },
          { id: "c0n4", name: "祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是祭祀面，层位不能乱，饭香也不能乱，先分清灶火和青铜气。"], artifactHint: 0 },
          { id: "c0n5", name: "青铜门墓", level: 19, isTomb: true, discover: ["chenli", "门缝里有光，陶盉温痕也对上了。I 级大墓——青铜门启。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇五三，超越期第十一日。门后风带着铜锈味，也带一点陶盉温酒后的甜酸味。"], artifactHint: 0 },
          { id: "c1n1", name: "封土区", level: 24, x: -1.8, z: 0.5, discover: ["yangxue", "封土层！消除相邻文物等于震土，但二〇五三模型提醒：生活残留和扰层边界要分开记。"], artifactHint: 3 },
          ...
          { id: "c1n4", name: "千面阵", level: 38, x: 2.5, z: -2.8, discover: ["wangdun", "妈呀，全是眼睛！胖爷先消一层——金牙刘闭上你的估价嘴，杨雪的伙食声纹笔还亮着！"], artifactHint: 0 },
          { id: "c1n5", name: "纵目神墓", level: 39, isTomb: true, discover: ["hutan", "II 级大墓。纵目之神，在等我们读完层位。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇五三第十一日，胖爷少贫嘴，第一铲先看饭盒盖紧没！"], artifactHint: 2 },
          { id: "c2n1", name: "树腰洞", level: 44, x: -1.5, z: 1, discover: ["hutan", "树腰有榫眼。古蜀人插真枝于此，二〇五三的罗盘说它还在长，也在记祭后炊烟。"], artifactHint: 2 },
          { id: "c2n2", name: "半百祭台", level: 49, x: 0, z: -0.2, discover: ["chenli", "第五十层探方。半百之数，祭台现；生活复原档案室给它补了二〇五三标签。"], artifactHint: 5 },
