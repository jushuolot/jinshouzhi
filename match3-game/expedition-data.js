...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后新营", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。雨停才半刻，新坑晨会已经开完——自一九二九首发现快进的一百一十八年，今天接着记。"], artifactHint: 3 },
          { id: "c0n1", name: "晨会陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！早饭才半碗也能挖，刘哥你别顺手揣兜里！"], artifactHint: 3 },
          { id: "c0n2", name: "新坑象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！新坑扫描把纹路连到神树根系，古蜀不产象，这条路比人间档案更远。"], artifactHint: 4 },
      ...
      {
        nodes: [
          { id: "c2n0", name: "树根层", level: 40, x: -3, z: 2.5, discover: ["wangdun", "神树！根比胖爷腰还粗——二〇四七第八日，胖爷新坑第一铲就碰上硬茬！"], artifactHint: 2 },
