...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "雨后营地", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇五三，第十一日馋嘴生活日。探照灯撕开回潮的雨泥——资料室重开，陶盉谷物和营地热汤从第一铲一起记。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别把二〇五三样本签贴饭盒盖上！"], artifactHint: 3 },
          { id: "c0n2", name: "象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！古蜀不产象，这是远方来的；旁边的谷物残留说明他们也会认真吃饭。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，二〇五三的生活档案不能把泡面债也写进去吧？"], artifactHint: 1 },
          { id: "c0n4", name: "祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。前面是祭祀面，层位不能乱，灶烟味和铜锈味混在一起，先记后动。"], artifactHint: 0 },
          { id: "c0n5", name: "青铜门墓", level: 19, isTomb: true, discover: ["chenli", "门缝里有光，陶盉残渣也亮了。I 级大墓——青铜门启。"], artifactHint: 0 },
        ],
      },
      {
        nodes: [
          { id: "c1n0", name: "门后甬道", level: 20, x: -3.2, z: 2, discover: ["yangxue", "二〇五三，超越期第十一日。门后风带着铜锈味，也带着营地热汤味——生活档案比人间论文快一代。"], artifactHint: 0 },
          { id: "c1n1", name: "封土区", level: 24, x: -1.8, z: 0.5, discover: ["yangxue", "封土层！消除相邻文物等于震土，但二〇五三模型提醒：谷物样本要先避开回压边。"], artifactHint: 3 },
      ...
      },
      {
        nodes: [
          ...
          { id: "c2n1", name: "树腰洞", level: 44, x: -1.5, z: 1, discover: ["hutan", "树腰有榫眼。古蜀人插真枝于此，二〇五三的罗盘说它还在长，也在记营地烟火。"], artifactHint: 2 },
