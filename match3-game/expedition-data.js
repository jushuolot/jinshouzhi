...
(function () {
  ...
  window.MATCH3_EXPEDITION = {
    ...
    chapters: [
      {
        nodes: [
          { id: "c0n0", name: "晨雾新营", level: 0, x: -3.5, z: 2.2, discover: ["chenli", "二〇四七，超越期第八日。晨雾压着新坑——造物主不在屏前，层位照样往前走两年。"], artifactHint: 3 },
          { id: "c0n1", name: "陶片层", level: 4, x: -2, z: 0.8, discover: ["wangdun", "胖爷铲子下去——陶片！成片的！刘哥你别顺手揣兜里，热豆花也别揣样品袋！"], artifactHint: 3 },
          { id: "c0n2", name: "象牙露头", level: 9, x: -0.5, z: -0.3, discover: ["yangxue", "象牙饰！二〇四七扫描提示它和水路祭仪有关，古蜀不产象，来路更要记清。"], artifactHint: 4 },
          { id: "c0n3", name: "金粉纹层", level: 14, x: 1, z: -1.2, discover: ["jinyaliu", "金粉！刘哥我……就看看！王墩你闭嘴，今早豆花凉了也不是我一个人的锅！"], artifactHint: 1 },
          { id: "c0n4", name: "祭祀面", level: 18, x: 2.2, z: -2, discover: ["hutan", "罗盘疯了。二〇四七的新坑祭祀面在前，层位不能乱，呼吸都放轻。"], artifactHint: 0 },
