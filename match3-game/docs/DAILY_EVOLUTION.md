...
| `public_commons_mirror` | `network_settlement` | 超越期每日公开资料镜像 |
| `beyond_phase_presence` | `passive_yield` | 超越期会话驻场 tick |
| `weekly_recap` | `network_settlement` | 宇宙第七日收工复盘 |
| `new_pit_telemetry` | `network_settlement` | 宇宙新一圈下新坑时同步层位遥测 |
...
- 文明时钟、堪舆图、桌面 VN、发现弹窗、三星盛典、新坑遥测寻金渠道已就绪
