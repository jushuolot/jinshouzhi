...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五一——第十日险情日。凌晨坑壁湿度报警，资料室把警报声也编进超越期避险档案。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是青铜门缝在提醒我们先稳坑壁。"),
            line("wangdun", "胖爷我铲子和安全绳都磨好了！先消表层陶片——金牙刘你别把应急编号签当菜单看！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天所有动作按二〇五一避险模型归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇五一，第十日险情日。金面数据早越过人间二〇二一——封土层照旧，先用湿度警报校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五一的险情声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五一，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都先看坑壁回压。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五一的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日险情警报同频。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五一的罗盘还在快进——险情压住了，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账晚点算。" },
      { who: "杨雪", text: "记录完美，可以写进 2051 坑壁险情版新坑报告。" },
