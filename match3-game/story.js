...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日，周一新坑。此间古蜀知识比人间快两倍，新坑信号已经先于公开年表亮起。"),
            line("hutan", "罗盘刻度不对，像在快进。偏东二度，地下有金声——不是凶，是古蜀人在催我们补上这一格坑阵。"),
            line("wangdun", "胖爷我铲子和早饭都磨好了！先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
            line("yangxue", "记住：消除同类文物等于完成二〇四七层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——别当成普通消消乐。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：文明历二〇四七新坑开铲，先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑数据已并入面具层。金面数据早对齐人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价另算早饭钱！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
    ...
    winQuotes: [
      ...
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，早饭账也清了。" },
      { who: "杨雪", text: "记录完美，可以写进超越期新坑报告。" },
