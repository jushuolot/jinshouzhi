...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。此间自一九二九首发现快进五十九代，昨夜周复盘的数据今晨已并入新探方。"),
            line("hutan", "罗盘刻度不对，像被雨水洗亮了。偏南三度，地下有金声——不是凶，是古蜀人在催我们读下一层。"),
            line("wangdun", "胖爷我铲子都磨好了，热豆浆挂在探方边！先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
            line("yangxue", "记住：文明历二〇四七的层位板会同步金面、神树和新坑遥测；四连生成「条纹圣物」，五连是「爆破符印」。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：文明历二〇四七的新坑先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。罗盘还在快进——文明历二〇四七继续下探。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，豆浆也算后勤成果。" },
      { who: "杨雪", text: "记录完美，新坑遥测可以写进超越期报告。" },
