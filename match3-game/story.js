...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历已至二〇三三——此间复兴期又快进两年。昨夜田野笔记镜像回传，七八号坑数据和一号坑封土能对上了。"),
            line("hutan", "罗盘刻度不对，像在替符号墙翻页。偏南三度，地下有金声——不是凶，是古蜀人在催我们别把线索熬凉。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇三三的七、八号坑金面数据已和面具层同步——从本章起还有「封土层」（冰块），消相邻文物可震碎，别被埋住。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇三三，复兴期的神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间又多读了一圈枝序。"),
        ...
        beats: {
          ...
          55: [line("jinyaliu", "神鸟文物能卖……不对，能换论文署名吗？二〇三三的复兴期总得给刘哥留个脚注吧。")],
    ...
    winQuotes: [
      ...
      { who: "杨雪", text: "记录完美，2033 版田野笔记终于能补上这一页。" },
