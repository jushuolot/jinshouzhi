...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五一——第十日险情日。神树坑半夜传来低频铜鸣，资料室把警戒声纹列为超越期安全档案。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南六度，地下有金声——先别慌，不是凶，是二〇五一的坑阵在催我们按规矩下铲。"),
            line("wangdun", "胖爷我铲子和冷馒头都备好了！先消表层陶片——刘哥，今天谁乱碰编号签谁守夜。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——险情日每一步都写进二〇五一安全档案。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇五一，第十日险情日。金面数据早越过人间二〇二一——封土层照旧，先用夜巡声纹校准夯土。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五一，神树层位自己往上升——青铜神树高近四米，九枝九鸟。昨夜低频铜鸣被超越期读成枝杈预警，棋盘就是缩微警戒图。"),
    ...
    winQuotes: [
      ...
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，守夜那份冷馒头也算功劳。" },
      { who: "杨雪", text: "记录完美，可以写进 2051 险情声纹版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没碰警戒编号签。" },
    ],
    failQuotes: [
