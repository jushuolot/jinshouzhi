    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日，下新坑。此间古蜀知识又比人间快走两年，公开图鉴和扫描层位先在晨雾里对齐。"),
            line("hutan", "罗盘比人醒得早。偏南三度，地下金声更清——不是凶，是新坑在敲门，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷我早饭只喝了半碗稀饭，铲子倒磨得锃亮！先消表层陶片——金牙刘，你手离样本袋远点。"),
            line("yangxue", "新坑第一规：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」，二〇四七的记录要更干净。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑回测。金面数据早对齐人间二〇二一，新扫描又补了两圈封土误差——消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——刘哥你别在后面估价，今天新坑早班，估价也得排队！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，超越期新坑数据回灌神树层——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间又快了一步。"),
