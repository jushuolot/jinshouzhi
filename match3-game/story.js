...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴。资料室把营地口供转成索引，此间古蜀知识又比人间快走两年。"),
            line("hutan", "罗盘刻度被王墩的花椒面熏歪了。偏南四度，地下有金声——不是凶，是新坑在听你俩吵架。"),
            line("wangdun", "胖爷我铲子磨好了，早饭也护住了！金牙刘，你再说花椒面是陪葬调料，我就把你归进封土层。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——二〇四九的语音索引会把你们每句吵架都标到层位里。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴。金面数据早越过人间二〇二一——封土层照旧，先用新坑编号和你们的口音校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价另算工钱，还得赔我花椒面！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更快，连拌嘴都能补一条枝序。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘还在快进——拌嘴归拌嘴，坑还得下。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，花椒面账也算刘哥头上。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 新坑语音索引。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——花椒面另算。" },
    ],
    failQuotes: [
