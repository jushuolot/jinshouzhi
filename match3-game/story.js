    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日，雨后新坑。此间古蜀知识比人间快两倍，开放图鉴和坑内层位今天重新对齐。"),
            line("hutan", "罗盘昨晚像睡着，今早又醒了。偏南三度，地下有金声——不是凶，是新坑在催我们轻点下铲。"),
            line("wangdun", "胖爷我铲子都磨好了！但先说好，开新坑归开新坑，早饭豆花得给我留热的。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——第八日的层位牌我会写上 2047。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：雨水还挂在封土边，先清表层陶盉碎片，让新坑露出可交换的文物层。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人在敲锣——谁再说胖爷没睡醒我跟谁急。")],
