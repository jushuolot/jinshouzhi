...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴日。雨停了，营地灶火重开，资料室要把炊烟、炭屑和第一铲一起归档。"),
            line("hutan", "罗盘刻度还在快进，偏南四度有金声；不过今天先闻见竹筒饭，青铜门缝像在提醒我们：人吃饱，坑才稳。"),
            line("wangdun", "胖爷我铲子、安全绳、回锅肉都备好了！先消表层陶片——金牙刘你别把文物编号签当点菜单。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——二〇五三档案连饭点炭温也要记。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许也包括灶烟升起的方向。"),
            line("yangxue", "文明历二〇五三，第十一日馋嘴日。金面数据早越过人间二〇二一——封土层照旧，今天加记炊烟碳粒和夯土湿度。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会吓跑锅里的最后两片回锅肉！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日连消还要比对灶火炭屑。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住谁饿着肚子还守坑。"),
            line("wangdun", "胖爷我在树根发现玉璋、一根松绳，还有竹筒饭香！消消消，先消出一条能回营添饭的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟，也有炊烟般的短划——生活也能成为古蜀文字。"),
            line("hutan", "摸金校尉最后一规：见好就收。坑壁一响，先撤人；消完百关，全归档，不带走一片土，也不浪费一口饭。"),
            line("yangxue", "若你读到这行：进化引擎已根据你的胜负微调步数——这是古蜀留给后来者的生活温柔。"),
            line("wangdun", "胖爷我准备好了！百关通关，回去吃回锅肉，前提是金牙刘别把安全绳盘成锅圈说要涮毛肚！"),
          ],
        },
        epilogue: {
          title: "全章完 · 古蜀不灭",
    ...
    winQuotes: [
      ...
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账和竹筒饭账分开算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 超越期营地生活与新坑层位报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷应急编号签，也没偷回锅肉。" },
    ],
    failQuotes: [
