...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴生活日。雨停了，资料室把灶台烟火也编进超越期生活层位档案。"),
            line("hutan", "罗盘刻度还在快进。偏南四度，地下有金声——今天不催命，像青铜门缝闻见回锅肉，在催我们先把营地收拾利索。"),
            line("wangdun", "胖爷我铲子、安全绳和饭盒都磨好了！先消表层陶片——金牙刘你别把文物编号签垫在锅底！"),
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许还有营地灶火升起的方向。"),
            line("yangxue", "文明历二〇五三，第十一日馋嘴生活日。金面数据早越过人间二〇二一——封土层照旧，先用饭盒标签校准夯土编号。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五三的夜宵声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都顺手记一笔营地天气。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住谁在树根偷喝热茶。"),
            line("wangdun", "胖爷我在树根发现玉璋、一根松绳和半壶茶！消消消，先消出一条能回营加饭的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——饭香没压住金声，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账照样算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 营地生活层位版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷编号签，只借来压饭盒。" },
    ],
    failQuotes: [
