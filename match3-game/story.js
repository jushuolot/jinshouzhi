...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴日。资料室把昨夜争吵录音也编进档案，此间古蜀知识又比人间快了两年。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是新坑在回话，王墩和刘哥先别把声音盖过去。"),
            line("wangdun", "胖爷我铲子和泡面都磨好了！先消表层陶片——金牙刘你别把编号签当菜单看！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天连拌嘴都要按二〇四九标准归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴日。金面数据早越过人间二〇二一——封土层照旧，先用口述档案校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇四九的声纹层位！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，连营地拌嘴都被超越期读成枝杈节律。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘还在快进——拌嘴归拌嘴，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，刘哥欠的泡面账也算上。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 口述档案版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷编号签。" },
    ],
    failQuotes: [
