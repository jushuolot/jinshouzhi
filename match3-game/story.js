    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。新坑雾线刚压到祭祀坑外沿，此间古蜀知识比人间快到第二圈末。"),
            line("hutan", "罗盘绳我今早刚换，针还是像在快进。偏南三度，地下有金声——不是凶，是古蜀人在催我们别睡过头。"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。纵目面具数据已把人间二〇二一新坑补成完整序列——消相邻文物，震落覆盖夯土。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七超越期，神树层位自己往上升——今日新坑测绘把树根坐标往东南挪三寸，九枝九鸟仍对天心。"),
