...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五一——第十日险情日。气压压到探方边缘，此间古蜀知识又比人间多走两年，安全绳先过我手。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声，也有渗水声——不是凶，是新坑在催我们按规矩慢下来。"),
            line("wangdun", "胖爷我铲子、绳结和热姜茶都备好了！先消表层陶片——刘哥，编号签今天不许离开防水袋。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天所有闪灯都按二〇五一险情档案留痕。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇五一，第十日险情日。金面数据早越过人间二〇二一——封土层照旧，先用渗水线校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会盖过二〇五一的头灯报警！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五一，神树层位在雷声里自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，连头灯闪频都被超越期读成枝杈节律。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五一的罗盘还在快进——险情解除一格，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加姜茶，刘哥负责把防水袋数清楚。" },
      { who: "杨雪", text: "记录完美，可以写进 2051 险情巡更版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没把头灯当金器估价。" },
    ],
    failQuotes: [
      { who: "胡探", text: "别急，头灯闪三下就停铲，换一步风水再进。" },
      { who: "王墩", text: "失败算啥，胖爷摔过的泥坡比探方还多，绳子还在。" },
      { who: "杨雪", text: "步数用尽不代表层位错了，先标渗水线，重来一次。" },
    ],
  };
})();
