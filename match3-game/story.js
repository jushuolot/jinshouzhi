    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日，新坑刚开口。此间比人间又快两年，公开图鉴要重新贴到今日层位上。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，新探方底下有金声——不是凶，是古蜀人在催我们别迟到。"),
            line("wangdun", "胖爷早饭没吃饱，铲子倒磨亮了！先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。金面数据早越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——刘哥你别估价，先把雨鞋里的泥倒了！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "文明历二〇四七，百关最后一程。符号墙上有目、有树、有鸟——与今日新坑六类文物一一对应。"),
