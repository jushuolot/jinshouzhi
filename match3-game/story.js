    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日周一下新坑。此间从一九二九七月首发现快进了一百一十八年，新坑层位要接入神树档案。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，地下有金声——不是凶，是新坑在催我们开第一铲，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——但早饭只吃半碗，谁再催胖爷就让谁背方便面！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑晨会。金面数据早对齐人间二〇二一，新坑扫描又补出半圈眼纹——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，晨会纪要写着估价另算工钱！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，超越期新坑把神树根系补全了——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快。"),
