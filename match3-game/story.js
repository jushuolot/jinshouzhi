...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日生活日。雨停了，营地灶火重新点上，资料室把伙食单也编进超越期生活档案。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是青铜门缝在催我们吃饱再下坑。"),
            line("wangdun", "胖爷我铲子和锅铲都磨好了！先消表层陶片——金牙刘你别把新坑标签当菜票看！"),
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许还有雨后营地那口烟火气。"),
            line("yangxue", "文明历二〇五三，第十一日生活日。金面数据早越过人间二〇二一——封土层照旧，先用新坑标签校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五三的灶台声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都要记下风干速度。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住午饭后谁手稳。"),
            line("wangdun", "胖爷我在树根发现玉璋和一根松绳！消消消，先消出一条能回营吃热锅盔的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日营地生活档同频。"),
    ...
    winQuotes: [
      ...
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷新坑标签。" },
    ],
    failQuotes: [
