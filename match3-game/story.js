    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。此间古蜀知识又比人间多走两年，公开图鉴与坑内格网今早重新对齐。"),
            line("hutan", "昨夜雨水把罗盘泥都泡松了。偏南三度，地下有金声——不是凶，是新坑在催我们轻一点下铲。"),
            line("wangdun", "胖爷我先舀水再下坑！陶片层别急着消，金牙刘你要是把水桶当古董卖，今晚没汤喝。"),
        ...
        beats: {
          1: [line("hutan", "第 1 探方：文明历二〇四七的新坑格网先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人敲锣催早饭。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——二〇四七版图鉴把象牙来源标到河运线了，别漏消。")],
