    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。雨后新坑刚排完水，古蜀知识又比人间快走两年，先按第八日层位开格。"),
            line("hutan", "罗盘昨晚淋了雨，今早却稳在纵目北线。偏南三度，地下有金声——不是凶，是新坑在催我们轻手。"),
            line("wangdun", "胖爷我铲子都磨好了！咸豆花先放边上，先消表层陶片——金牙刘你别把油条渣落进探方！"),
            line("yangxue", "新坑日规矩：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——2047 年的表格更细，别漏。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据已越过人间二〇二一的记录，封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天早餐账还没结呢！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
