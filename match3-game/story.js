    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。新坑晨雾刚散，公开图鉴、层位扫描和队员饭点都得重新对表。"),
            line("hutan", "罗盘铜针昨夜换过，还是偏南三度。地下金声像在催工——不是凶，是古蜀人在叫我们开新坑。"),
            line("wangdun", "胖爷我铲子都磨好了，热豆花也订好了！先消表层陶片——金牙刘你别拿样品袋装早饭！"),
            line("yangxue", "二〇四七标准：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——手快也要标注清楚。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：新坑开图，先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
          5: [line("wangdun", "五层了！文明历二〇四七的金属回响比昨天亮，像有人在坑底敲开工锣。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——二〇四七的扫描说它和水路祭仪有关，别漏消。")],
