    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。此间古蜀知识比人间又快两年，昨夜刚校完的新坑索引图，今早就有回声。"),
            line("hutan", "罗盘被雨气压得发闷，偏南三度半。地下那声金响不是催命，是古蜀人把第一层封土递到我们手上。"),
            line("wangdun", "胖爷我铲子等了一夜！新坑第一铲归我，金牙刘负责看包——不许把编号牌当古董问价。"),
            line("yangxue", "今天按二〇四七符号表重标层位：消除同类文物等于完成记录，四连是条纹圣物，五连仍是爆破符印。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：新坑先清表层陶盉碎片，别急着追分，先让层位露出可交换的脉络。")],
          5: [line("wangdun", "五层了！雨水还滴胖爷后脖子，地下金属回响却越来越亮，像有人在敲开工锣。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据早对齐人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，超越期。神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快。"),
