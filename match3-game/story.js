    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。昨夜一圈宇宙复盘完，今早新坑编号已经压在青铜门外侧。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，新探方下面有金声——不是凶，是古蜀人在催我们读下一页。"),
            line("wangdun", "胖爷我冷馒头还没啃完，铲子先磨好了！金牙刘，今天你碰金粉前先报备。"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑记录。金面数据已越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——刘哥你今天别估价，先帮我把雾水擦干！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
