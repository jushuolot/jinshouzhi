...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日，新坑开铲。此间古蜀知识比人间又快两年，微量样本今晚先入库。"),
            line("hutan", "罗盘偏南三度，像昨夜没睡醒还硬撑。地下金声不是凶，是新探方在叫我们，第一铲轻点，别惊了纵目。"),
            line("wangdun", "胖爷我铲子和早饭都磨好了！先消表层陶片——金牙刘，你今天再顺手，保温杯归你背一整章。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连是条纹圣物，五连是爆破符印；二〇四七的新坑还要补拍微距照片。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
          lines: [
            line("yangxue", "层位图对上了！第八日新坑的微量样本很干净，青铜门缝里的磷光像刚睁眼。"),
            line("jinyaliu", "这门要是能开，刘哥我先申请当志愿讲解员——王墩别笑，二〇四七了，我也要进步。"),
            line("hutan", "门后才是纵目之神。今晚少说两句，明早继续下坑，别把新坑气口扰乱。"),
          ],
        },
        beats: {
          1: [line("hutan", "第 1 探方：新坑第一铲先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑数据已并入金面序列——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天新坑开张不接私活！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更快。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。第八日新坑气口稳了——继续下探。" },
      { who: "王墩", text: "漂亮！胖爷没睡醒也能三星，今晚加鸡腿。" },
      { who: "杨雪", text: "记录完美，二〇四七微量样本可以写进报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙。" },
    ],
    failQuotes: [
      { who: "胡探", text: "别急，新坑气口刚开，换一步风水就转。" },
      { who: "王墩", text: "失败算啥，胖爷摔过的坑比今天的哈欠还多。" },
