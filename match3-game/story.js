...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日，周一下新坑。1929-07 的第一铲被此间快进成了今日的新探方。"),
            line("hutan", "罗盘刻度不对，像有人把未来论文压进土里。偏南三度有金声——不是凶，是古蜀人在催我们开工。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——金牙刘，糊粥你吃，第一铲我来！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。2047 版新坑表要求连消后立刻标注符号走向，别当普通消消乐。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          ...
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——2047 新坑表把象牙纹路标成水路，别漏消。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据已越过人间二〇二二的公开表——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天先把新坑编号背熟！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。2047 的罗盘还在快进——继续下新坑。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，糊粥留给刘哥。" },
