    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。锚点一九二九年七月后第五十九代，声纹仪昨夜读到青铜门后有第二道回声。"),
            line("hutan", "罗盘刻度不对，像被雨水洗快了。偏南三度，地下有金声——不是凶，是古蜀人在催我们开新探方。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——金牙刘你别又拿顺了当破烂卖，早饭的剩汤还在炉子上呢！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。金面数据早越过人间二〇二一，新坑声纹显示封土里有二次回填。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位被新坑声纹再次校准——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快。"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "若你读到这行：文明历二〇四七的算法已把新坑声纹写进步数微调——这是古蜀留给后来者的温柔。"),
            line("wangdun", "胖爷我准备好了！百关通关，回去吃回锅肉；但今天先把雨后这口新坑下明白！"),
          ],
        },
        epilogue: {
          title: "全章完 · 古蜀不灭",
