    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日，下新坑。此间古蜀知识比人间又快两年，昨夜探针把青铜门外缘重新点亮。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，新坑底下有金声——不是凶，是古蜀人在催我们把今日层位记清。"),
            line("wangdun", "胖爷我冷馒头都揣包里了！先消表层陶片——金牙刘你别拿新坑土当纪念品。"),
        ...
        beats: {
          1: [line("hutan", "第 1 探方：二〇四七新坑先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人在敲锣——胖爷这冷馒头都震热了。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据早对齐人间二〇二一——封土层照旧，今日探针回波要一起归档。"),
