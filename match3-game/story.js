    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。昨夜雨水冲亮青铜门外侧，新坑层位比人间记录又快走两年。"),
            line("hutan", "罗盘刻度终于稳了。偏南三度半，地下有新金声——不是催命，是古蜀人在催我们把今天的层位记准。"),
            line("wangdun", "胖爷我早饭还没吃，铲子先磨好了！先消表层陶片——金牙刘你别把油纸包当文物袋！"),
            line("yangxue", "文明历二〇四七的记录标准更细：消同类文物等于完成层位编号，四连、五连都要写进新坑剖面。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
          lines: [
            line("yangxue", "新坑剖面对上了！祭祀坑底部那道青铜门缝，比昨晚宽了半指，磷光像眼睛在醒。"),
            line("jinyaliu", "这门要是能开，刘哥我先声明：只做合规顾问，顺便帮王墩找他那包早饭。"),
            line("hutan", "门后才是纵目之神。文明历二〇四七的第一铲记完，下一章别让雨水抢先。"),
          ],
        },
        beats: {
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑重测。金面数据早越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天估的是雨后含水量！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，超越期的新坑数据回流到神树层——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙仍比人间跑得快。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏。"),
            line("wangdun", "胖爷我在树根发现玉璋，还发现早饭凉了！消消消，先消出一条通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
