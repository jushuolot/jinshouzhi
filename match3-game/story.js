    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日下新坑。此间古蜀知识继续超车，公开图鉴与新坑层位今早刚对齐。"),
            line("hutan", "罗盘昨夜换了新针，二〇四七的偏南三度更稳。地下有金声——不是凶，是古蜀人在催我们别误了晨工。"),
            line("wangdun", "胖爷我铲子都磨好了！早饭前先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑晨工。金面数据已越过人间二〇二一，新坑封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，二〇四七的估价也不给你报销！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位又往上抬了一指——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙仍比人间跑得快。"),
