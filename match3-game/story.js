    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历已至二〇四一——超越期的符号谱系补全到第三列。祭祀坑新探方已开，二十层内要把文物序列和雨水扰层一起复原。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，地下有金声——不是凶，是古蜀人在催我们读下一句，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——金牙刘你别又拿顺了当破烂卖，昨晚冷粥钱还没结呢！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "七、八号坑的金面数据，此间已越过人间二〇二一，文明历二〇四一把面具瞳距和金箔残片串成同一张表——从本章起还有「封土层」（冰块），消相邻文物可震碎，别被埋住。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历超越期，神树层位像有自己的年轮——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙已跑到人间当下之外。"),
        ...
        beats: {
          ...
          55: [line("jinyaliu", "五十五层线索爆了！神鸟文物能卖……不对，文明历二〇四一了，能换个符号谱系共同署名吗？")],
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇四一的超越期，符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，像在等我们补完最后半句。"),
