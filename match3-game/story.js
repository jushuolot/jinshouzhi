...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历已至二〇四一——超越期的符号谱反推到第一探方，二十层文物序列要重新校一遍。"),
            line("hutan", "罗盘刻度不对，像昨夜被神树拨快。偏南三度，地下金声在催稿——不是凶，是古蜀人嫌我们记录慢。"),
            line("wangdun", "胖爷铲子磨好了，汗也流够了！先消表层陶片——金牙刘你别拿编号袋当零食袋！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "七、八号坑的金面数据，此间已对齐人间二〇二一——从本章起还有「封土层」（冰块），消相邻文物可震碎，别被埋住。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇四一，符号墙不再只等我们读——它把目、树、鸟的谱系倒灌回七、八号坑。"),
            line("hutan", "摸金校尉最后一规：见好就收。今晚线索爆了也别昏头，全归档，不带走一片土。"),
            line("yangxue", "我把超越期符号谱接进层位表了。若步数微调，那不是玄学，是这片土地在给后来者留余量。"),
            line("wangdun", "胖爷我准备好了！百关通关，先喝水，再吃回锅肉——今天这闷热能把青铜都蒸出汗。"),
          ],
        },
        epilogue: {
          title: "全章完 · 古蜀不灭",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。罗盘快进到二〇四一了，继续追这条回流线。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，再加一碗不坨的泡面。" },
      { who: "杨雪", text: "记录完美，超越期符号谱可以补一行脚注。" },
