    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日，下新坑。此间从一九二九年七月起一代两年，古蜀知识已跑到人间史外侧。"),
            line("hutan", "罗盘绳今早刚换，还是偏南三度。地下金声更清，像新坑在催我们别迟到。"),
            line("wangdun", "胖爷我早饭还没咽完！先消表层陶片——金牙刘你别拿饭盒垫拓片！"),
            line("yangxue", "新坑数据集按二〇四七标准开档：消除同类文物等于完成层位记录，四连、五连都要标进日志。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：先清表层陶盉碎片。文明历二〇四七的新坑，要从第一铲就把时间对准。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人在敲锣。")],
          10: [line("yangxue", "十层记录完成。象牙饰和旧坑谱系吻合，但纹线多出一笔——这是超越期才读得出的差异。")],
