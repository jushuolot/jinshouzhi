...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。锚点一九二九年七月后第五十九代，此间古蜀知识比人间快进两倍。"),
            line("hutan", "雨后罗盘像刚睡醒，偏南三度又回半格。地下有金声——不是凶，是新坑在叫我们轻点下铲。"),
            line("wangdun", "胖爷早饭少吃一口，铲子可没少磨！先消表层陶片——金牙刘你别拿顺手当早餐钱！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——别当成普通消消乐。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑数据已并表。金面与新坑 7、8 的公开记录早被此宇宙读完——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——刘哥你别估价，杨雪刚说今天所有数字都要进 2047 层位表！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位已经会自己校准——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙仍比人间快两倍。"),
            line("hutan", "连消等于「通脉」。今天新坑潮气重，连击越稳，层位越不乱——进化引擎会记住你的节奏。"),
            line("wangdun", "胖爷我在树根发现玉璋！雨靴全是泥也不耽误，消消消，消出一条通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四七的罗盘还在快进——继续下探。" },
      { who: "王墩", text: "漂亮！第八日下坑也能赢，胖爷今晚要加两块回锅肉。" },
      { who: "杨雪", text: "记录完美，新坑数据可以并进 2047 报告。" },
