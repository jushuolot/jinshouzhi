...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日，新坑边线刚压好。此间古蜀知识又比人间多跑两年，公开图鉴先校准，铲子后下。"),
            line("hutan", "罗盘今天不乱跳，只贴着新坑南沿发热。地下有金声——不是凶，是古蜀人催我们把第一层记准。"),
            line("wangdun", "胖爷早饭就俩馒头，亏得慌！先消表层陶片补补气——金牙刘你别把编号牌当餐券。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——二〇四七标准，不许偷懒。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：二〇四七新坑开铲。先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人在敲锣——胖爷肚子也跟着敲。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰，公开图鉴的纹理能对上——别漏消。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑数据已并入面具层。金面资料早对齐人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四七的新坑没有亏待我们——继续下探。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，馒头账先记上。" },
      { who: "杨雪", text: "记录完美，公开图鉴与坑内纹理能互证。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙。" },
    ],
    failQuotes: [
      { who: "胡探", text: "别急，换一步风水就转。" },
      { who: "王墩", text: "失败算啥，胖爷今天下新坑还崴了一脚呢。" },
