...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴日。资料室把新坑符号索引又推两年，层位表旁那张煎饼先别让王墩和金牙刘打起来。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是新坑在回话；地上两位吵归吵，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷我铲子和早饭都磨好了！先消表层陶片——金牙刘你少说二〇四九也得讲先来后到，煎饼是胖爷的！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴日。金面数据早越过人间二〇二一——封土层照旧，先用超越期索引校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价另算工钱，煎饼另算精神损失！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更快，连拌嘴都能变成索引脚注。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘还在快进——吵完继续下坑。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，早饭账让刘哥先记，别扣我的。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 超越期新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——煎饼钱另结。" },
    ],
    failQuotes: [
