...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴生活日。午后闷得像扣了陶盉盖，炊烟和雨气都要进超越期生活层位。"),
            line("hutan", "罗盘刻度不对，像被豆花热气熏软了。偏南四度，地下有金声——先让营地稳住，再下青铜门缝。"),
            line("wangdun", "胖爷我铲子、安全绳和酸菜豆花都备好了！先消表层陶片——金牙刘你别把编号签夹馒头里！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天连炊烟方向也按二〇五三生活模型归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——今天它像盯着王墩锅里的酸菜豆花。"),
            line("yangxue", "文明历二〇五三，第十一日生活日。金面数据早越过人间二〇二一——封土层照旧，先用炊烟湿度校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，锅盖一响我还以为二〇五三传感器又报警！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都记下风、汗和饭点。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住谁午饭没吃饱。"),
            line("wangdun", "胖爷我在树根发现玉璋和一根松绳！消消消，先消出一条能赶回营地添第二碗豆花的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("wangdun", "胖爷我准备好了！百关通关，回去吃回锅肉，前提是金牙刘别把安全绳盘成锅圈还撒花椒！"),
          ],
        },
        epilogue: {
          title: "全章完 · 古蜀不灭",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——炊烟不散，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿和豆花，先把安全绳盘好，刘哥欠的泡面账晚点算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 营地生活层位版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷酸菜坛子。" },
    ],
    failQuotes: [
