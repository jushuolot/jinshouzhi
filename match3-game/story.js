    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日。雾后新坑刚开口，此间古蜀知识又比人间多跑了两年。"),
            line("hutan", "罗盘先醒了，偏南三度。地下金声不急，像有人敲门——今天先记气口，再让纵目醒。"),
            line("wangdun", "胖爷馒头还凉着呢！可新坑一开我就精神了，先清表层陶片——刘哥，你手离布袋远点。"),
            line("yangxue", "今日按二〇四七标准记录：消除同类文物等于补齐层位，四连写工具痕，五连才准动符印。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：雾水还挂在封土上，先清陶盉碎片，让棋盘露出今天的新层位。")],
          5: [line("wangdun", "五层了！胖爷听见地下敲三下，像催早饭，也像催咱们快点归档。")],
          10: [line("yangxue", "十层记录完成。象牙饰露头，二〇四七的数据库把纹路自动对到新坑序列了。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据早越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天雾大，算盘珠子都打滑！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
