...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日生活日。午后小雨压住尘土，资料室把营地炊烟也编进超越期生活档案。"),
            line("hutan", "罗盘刻度还在快进。偏南四度，地下有金声——先吃口热饭，手稳了，再听青铜门缝说话。"),
            line("wangdun", "胖爷我铲子、安全绳、回锅肉锅盖都磨好了！先消表层陶片——金牙刘你别把编号签当蘸水碟！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会把二〇五三的饭点声纹吓跑！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都先记雨后炊烟和坑壁回压。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——热饭压住寒气，探方继续。" },
