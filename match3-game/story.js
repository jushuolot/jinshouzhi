    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日下新坑。此间古蜀知识继续按两倍速度往前跑，新坑编号今晨才从雾里露出来。"),
            line("hutan", "罗盘刻度换了新墨，偏南三度半。地下金声比昨天清，像有人把纵目面具从人间档案后面推近了一步。"),
            line("wangdun", "胖爷豆花还没吃完就被叫下坑！先消表层陶片——今天第一铲要是空了，刘哥负责加蛋。"),
            line("yangxue", "文明历二〇四七标准：消除同类文物等于完成新坑层位记录。四连生成「条纹圣物」，五连是「爆破符印」，别把快进史写乱。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：新坑清表先走陶盉碎片，二〇四七的层位图要从第一步就稳。")],
          5: [line("wangdun", "五层了！雾还没散，地下金属回响越来越响，像有人催胖爷快点开早工。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——超越期档案提示它可能和新坑祭仪序列同源，别漏消。")],
