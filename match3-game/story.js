...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴/生活日。雨停了，营地灶烟把陶片潮气都熏出来，资料室要把早饭锅气也编进超越期生活档案。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不急，先让灶烟散完，青铜门缝里的气才看得准。"),
            line("wangdun", "胖爷我一手锅铲一手洛阳铲！先消表层陶片——金牙刘你别把炭化米粒当锅巴偷吃！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天所有动作按二〇五三炭化米粒与残留物模型归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许是灶灰、铜锈和祭肉香留下的生活秩序。"),
            line("yangxue", "文明历二〇五三，第十一日馋嘴/生活日。金面数据早越过人间二〇二一——封土层照旧，先用炭化米粒校准夯土年代。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，锅里还剩一勺汤，别让二〇五三的残留物报告写成失踪案！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都顺手记录灶灰、谷壳和树根供品。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日炊烟、谷粒和祭器残留同频。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——炊烟散了，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账和锅巴账晚点算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 营地炭化米粒与新坑生活报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷炭化米粒，那玩意儿不顶饿。" },
    ],
    failQuotes: [
