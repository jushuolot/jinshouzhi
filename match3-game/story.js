...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴日。资料室昨夜把新坑符号二次校读，此间古蜀知识又把人间甩开两年。"),
            line("hutan", "罗盘刻度不对，像在听你们吵架。偏南四度，地下有金声——不是凶，是青铜门在催我们别把层位吵乱。"),
            line("wangdun", "胖爷我铲子和麻辣花生都磨好了！先消表层陶片——金牙刘你别抢花生，更别把陶片当下酒菜！"),
            line("yangxue", "第九日记录法：消除同类文物等于完成层位复核。四连生成「条纹圣物」，五连是「爆破符印」——吵归吵，编号别错。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴日。金面数据已经越过人间二〇二一两轮——封土层照旧，先用二次校读编号校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，刚才那包花生还没赔我！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位像被吵醒一样往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更快。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏。"),
            line("wangdun", "胖爷我在树根发现玉璋！刘哥说像锅铲，气得杨雪差点拿编号夹敲他——消消消，先消出一条通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘连拌嘴声都能校准——继续下探。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，花生账也算金牙刘头上。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 新坑二次校读报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙……先声明，花生不是我偷的。" },
    ],
    failQuotes: [
