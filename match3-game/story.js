    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日。昨夜神树档案刚封箱，今晨新坑红线北移半尺，超越期的记录不能慢。"),
            line("hutan", "罗盘被雨气泡了一宿，刻度还在快进。偏北半尺有金声——不是凶，是古蜀新坑在催我们开线。"),
            line("wangdun", "胖爷我铲子磨好了，人还没醒！先消表层陶片——金牙刘你别把探方牌举反，说你呢。"),
            line("yangxue", "第八日按二〇四七标准重贴层位编号。四连生成「条纹圣物」，五连是「爆破符印」——今天别让哈欠扰层。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑开线。金面数据早越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——刘哥别在后面估价，今天新坑第一铲不许讲价！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位昨夜复核完毕——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙仍每夜跑两年。"),
