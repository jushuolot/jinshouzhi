    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，第二天雨停，营地全是湿柴味。三星堆祭祀坑新探方已开，先把吵着抢花生的两位领进队形。"),
            line("hutan", "罗盘偏南三度，地下有金声。不是凶，是古蜀人在催我们——小心行事，也别让王墩和金牙刘把锅吵翻。"),
            line("wangdun", "胖爷我铲子和早饭都备好了！金牙刘再偷我花生，我就先把他当封土层消一遍。"),
            line("yangxue", "今日层位备注：消除同类文物等于完成记录；王墩与金牙刘的拌嘴声，不计入有效声波样本。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
          lines: [
            ...
            line("jinyaliu", "这门要是能开，刘哥我先声明：花生是王墩自己放我包里的，跟古董可不是一回事……"),
        ...
        beats: {
          ...
          15: [line("jinyaliu", "十五层有金粉！刘哥我只拿……咳，帮你们鉴定，绝不私藏。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "从本章起会出现「封土层」（冰块）。消除相邻文物可震碎封土，别被埋住。"),
            line("wangdun", "面具看胖爷我看面具，看谁先眨眼！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "青铜神树高近四米，九枝九鸟。古蜀人相信树连接天地——我们的棋盘，就是缩微神树。"),
