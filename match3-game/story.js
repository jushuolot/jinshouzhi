...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴校勘。资料室把纵目编号又推前两年，吵归吵，层位不能错。"),
            line("hutan", "罗盘刻度不对，像被王墩和刘哥吵偏了。偏南四度，地下有金声——不是凶，是新坑在催我们读细一点。"),
            line("wangdun", "胖爷我铲子和煎饼都磨好了！先消表层陶片——金牙刘你再把编号牌当价签，我就把你挂探方边上。"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴校勘。金面数据已越过人间当下——封土层照旧，先用新坑编号校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天估价声也要按层位编号！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位在拌嘴声里又升两年——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更快。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘还在快进——吵归吵，继续校勘。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，刘哥的煎饼账也算上。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 新坑校勘报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——王墩你别瞪，我说的是合写报告。" },
    ],
    failQuotes: [
