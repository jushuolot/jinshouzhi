    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日。昨夜神树档刚封袋，今天新坑开口，此间古蜀知识又比人间多跑了两年。"),
            line("hutan", "罗盘比早饭先醒。偏南三度，地下有金声——不是凶，是新坑在催我们把第一层土记清楚。"),
            line("wangdun", "胖爷粥还没喝完，铲子已经磨亮！先消表层陶片——金牙刘你要顺手，今天就罚你洗全队饭盒。"),
            line("yangxue", "二〇四七标准：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——动作轻，别扰新坑。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：第八日新坑开工，先清表层陶盉碎片，让棋盘露出可交换的文物层。")],
          5: [line("wangdun", "五层了！二〇四七的土还挺倔，地下金属回响越来越响，像有人催胖爷收工前加班。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑延伸到面具层。金面数据早越过人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天新坑工钱按洗饭盒算！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位像昨夜还在呼吸——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快。"),
