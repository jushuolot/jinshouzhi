    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。新坑测绘格网刚摊开，古蜀知识又比人间多跑了两年。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，雨后的地下有金声——不是凶，是新坑在催我们下铲。"),
            line("wangdun", "胖爷我铲子都磨好了！包子还热着，先消表层陶片——金牙刘你别把饭盒当文物盒！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。金面数据早对齐人间二〇二一，新坑格网也接上了——封土层照旧，消相邻文物震碎夯土。"),
