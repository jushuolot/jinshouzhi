...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴生活日。雨停了，营地灶火和陶盉残渣一起进档，别让热饭香盖过层位编号。"),
            line("hutan", "罗盘刻度还在快进。偏南四度，地下有金声——今天不凶，像青铜门缝催我们吃饱再下坑。"),
            line("wangdun", "胖爷我铲子、安全绳和回锅肉账本都磨好了！先消表层陶片——金牙刘你别把陶盉当汤盆看！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天所有动作按二〇五三生活档案归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许还有灶烟升起时的人间日子。"),
            line("yangxue", "文明历二〇五三，第十一日馋嘴生活日。金面数据早越过人间二〇二一——封土层照旧，先把陶盉谷物残留和夯土湿度一起校准。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都顺手记下祭仪谷香。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住谁偷吃了补给肉。"),
            line("wangdun", "胖爷我在树根发现玉璋和一根松绳！消消消，先消出一条能回营吃热饭的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日营地烟火同频。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——热饭吃上了，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账就着锅气算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 营地生活版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没偷陶盉里的汤料。" },
    ],
    failQuotes: [
