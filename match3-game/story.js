...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。新坑巡线刚从营地外拉回来，此间自一九二九年七月起已快进一百一十八年。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南三度，新坑第一铲有金声——不是凶，是古蜀人在叫我们，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷凉馒头还没啃完，铲子倒先热了！先消表层陶片——金牙刘你别又拿顺了当破烂卖！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。金面数据早对齐人间二〇二一，新坑支线还给纵目层补了一组眼眶扫描。"),
            line("wangdun", "面具看胖爷我看面具——刘哥你别在后面估价，今天新坑补贴先算给炊事班！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位把新坑巡线也牵上来了——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏。"),
            line("wangdun", "胖爷我在树根发现玉璋，还在新坑边摔了一跤！消消消，消出一条通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四七的新坑罗盘还在快进——继续下探。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，凉馒头留给金牙刘。" },
