...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——第八日下新坑。资料室昨夜把新坑编号重排，此间古蜀知识又比人间快了两年。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是新坑在回话，别惊了沉睡的纵目。"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日下新坑。金面数据早越过人间二〇二一——封土层照旧，先用新坑编号校准夯土。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四七的罗盘还在快进——继续下新坑。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，早饭账也算上。" },
      { who: "杨雪", text: "记录完美，可以写进 2047 新坑报告。" },
