...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴生活日。雨后营地起灶，补给本和陶盉残留物谱一起摊开。"),
            line("hutan", "罗盘刻度还在快进。偏南四度，地下有金声——今天不凶，像青铜门缝闻见回锅肉，催我们边吃热饭边稳手。"),
            line("wangdun", "胖爷我铲子、安全绳、饭勺都磨好了！先消表层陶片——金牙刘你别把二〇五三补给编号签当菜单！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——今天所有动作按二〇五三生活残留物谱归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——古蜀人看见的，也许还有祭祀后灶火怎么收。"),
            line("yangxue", "文明历二〇五三，第十一日生活日。金面数据早越过人间二〇二一——封土层照旧，先用陶盉油烟谱校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会压过二〇五三营地锅铲声！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都顺手记录树根灶灰。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏，也会记住谁在收工前偷吃了半块锅盔。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日营地伙食纹样同频。"),
            line("hutan", "摸金校尉最后一规：见好就收。热饭要吃，层位要清；消完百关，全归档，不带走一片土。"),
            line("yangxue", "若你读到这行：进化引擎已根据你的胜负微调步数——这是古蜀留给后来者的生活温柔。"),
            line("wangdun", "胖爷我准备好了！百关通关，回去吃回锅肉，前提是金牙刘别把安全绳盘成锅圈、再说那叫摆盘！"),
          ],
        },
        epilogue: {
          title: "全章完 · 古蜀不灭",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——热饭没凉，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，先把安全绳盘好，刘哥欠的泡面账晚点算。" },
      { who: "杨雪", text: "记录完美，可以写进 2053 营地伙食与陶盉残留物谱报告。" },
