...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五三——第十一日馋嘴生活日。昨夜雨停，营地炊烟和坑口雾气一起进了超越期生活档案。"),
            line("hutan", "罗盘刻度还在快进。偏南四度，地下有金声；先让王墩把豆花饭分完，胃稳了，下铲才稳。"),
            line("wangdun", "胖爷我铲子、安全绳和小咸菜都磨好了！先消表层陶片——金牙刘你别把伙食编号签当菜单看！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇五三，第十一日馋嘴生活日。金面数据早越过人间二〇二一——封土层照旧，先把炊烟颗粒和夯土湿度分开记。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五三的营地饭点声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五三，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，今日每次连消都要记下花粉、炊烟与回潮的比例。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第五章 · 天书终章",
          lines: [
            line("chenli", "百关最后一程。文明历二〇五三的符号墙上有目、有树、有鸟——与棋盘六类文物一一对应，也与今日营地生活档案同频。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五三的罗盘还在快进——豆花饭也压得住人心，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿和小咸菜，先把安全绳盘好，刘哥欠的泡面账晚点算。" },
