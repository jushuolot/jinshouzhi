...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日下新坑。此间古蜀知识比人间当下超前二十一年，公开图鉴、传感探针与坑内层位今日重新对齐。"),
            line("hutan", "罗盘刻度不对，像被雨水洗出新脉。偏南三度，地下有金声——不是凶，是古蜀人在催我们换一座坑口。"),
            line("wangdun", "胖爷我铲子都磨好了！早饭还没咽完就下坑——金牙刘你别拿新编号袋装花生！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑复测。金面数据不只对齐人间二〇二一，还能反推符号边界——封土层照旧，消相邻文物震碎夯土。"),
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四七，神树层位像昨夜又长了一截——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得快，也比我们睡得少。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。第八日的新坑气口稳住了——继续下探。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，前提是刘哥没把饭盒抵押。" },
      { who: "杨雪", text: "记录完美，二〇四七版层位表终于有今天的呼吸声。" },
