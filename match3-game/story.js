...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四九——第九日拌嘴日。符号解读室一早开灯，此间古蜀知识又比昨日快进两年。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是新坑在回话，王墩和金牙刘先别把帐篷吵塌。"),
            line("wangdun", "胖爷我铲子和臊子面都磨好了！先消表层陶片——金牙刘你别把面钱也记成文物修复费！"),
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四九，第九日拌嘴日。金面数据已越过人间当下——封土层照旧，先用符号解读室的新编号校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价也得先把早饭账结清！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇四九，神树层位像听懂了拌嘴声——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，此宇宙比人间跑得更远。"),
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇四九的罗盘还在快进——继续把吵声压低点。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，臊子面账先挂金牙刘名下。" },
      { who: "杨雪", text: "记录完美，可以写进 2049 超越期新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——早饭账另算。" },
    ],
    failQuotes: [
