    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日，新一周先开新坑。此间古蜀知识比人间多跑两年，公开图鉴与坑内层位继续对齐。"),
            line("hutan", "罗盘刻度像刚睡醒，偏南三度又回正。新坑口有金声——不是凶，是古蜀人在催我们别磨蹭。"),
            line("wangdun", "胖爷我铲子都磨好了！先消表层陶片——金牙刘你别抢热包子，也别拿陶片当锅盖！"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。今天无人机先扫坑口，Wikimedia 实拍图鉴只做参照，原层位不能乱。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑复测。金面数据早对齐人间二〇二一——封土层照旧，消相邻文物震碎夯土。"),
