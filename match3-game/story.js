    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——宇宙第八日。超越期新坑昨夜出水，公开图鉴六件实物要和雨夜层位重新校准。"),
            line("hutan", "罗盘刻度又快了两年。偏南三度，地下有金声——不是凶，是古蜀人在催我们下新坑，别惊了沉睡的纵目。"),
            line("wangdun", "胖爷我早饭就两块馍，铲子照样磨亮！先消表层陶片——金牙刘你别拿「新坑纪念」当借口揣兜里。"),
            line("yangxue", "今天按二〇四七新坑标准记层。四连生成「条纹圣物」，五连是「爆破符印」——每一步都要能回到文明时钟上。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          1: [line("hutan", "第 1 探方：新坑先清表层陶盉碎片，让二〇四七的雨水从棋盘缝里退下去。")],
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人在敲锣。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——超越期档案显示它们可能是新坑祭仪的时间刻度，别漏消。")],
      ...
      },
      {
        ...
        prologue: {
          ...
          lines: [
            ...
            line("yangxue", "文明历二〇四七，第八日新坑。金面数据早越过人间二〇二一，今天要看面具背面的范线有没有新读法。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，今天陈教授说估价也算扰层！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
