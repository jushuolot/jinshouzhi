...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五一——第十日险情日。夜雨把纵目坑支架浇响了，此间古蜀知识又比人间快了两年，安全巡检也得跟着升级。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南四度，地下有金声——不是凶，是新坑在示警，先听木撑响，再动第一铲。"),
            line("wangdun", "胖爷我铲子和绳扣都磨好了！先消表层陶片——金牙刘你别挤支架，今天谁逞强谁洗锅。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——二〇五一的潮气数据也要一起归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——支架一响，它们像先看见了还没塌下来的明天。"),
            line("yangxue", "文明历二〇五一，第十日险情日。金面数据早越过人间二〇二一——封土层照旧，先用潮气传感和口述档案校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五一的支架声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五一，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，超越期把枝杈震颤也读成险情节律。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——但今天先看支点，通脉不能通成塌方。"),
            line("wangdun", "胖爷我在树根发现玉璋！消消消，消出一条通天路——刘哥你扶绳，别扶我的腰！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      { who: "胡探", text: "层位清晰。二〇五一的罗盘还在快进——险情过了，探方继续。" },
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，支架没塌，刘哥也没把绳扣当金链。" },
      { who: "杨雪", text: "记录完美，可以写进 2051 超越期险情巡检版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我刚才抱的是支架，不是金杖。" },
    ],
    failQuotes: [
