...
(function () {
  ...
  window.MATCH3_STORY = {
    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇五一——第十日险情日。凌晨三号坑微震三次，资料室把预警图推到青铜门前沿。"),
            line("hutan", "罗盘刻度不对，像在快进。偏南六度，地下有金声——不是凶，是门缝在卸力，先稳住表层。"),
            line("wangdun", "胖爷我铲子和冷粥都备好了！先消表层陶片——金牙刘你别踩我绳包，今天真有塌方相。"),
            line("yangxue", "记住：消除同类文物等于完成层位记录。四连会生成「条纹圣物」，五连是「爆破符印」——二〇五一的险情预警也要随手归档。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
      ...
      },
      {
        ...
        prologue: {
          title: "第二章 · 纵目之神",
          lines: [
            line("hutan", "门开了。第一张纵目青铜面具悬在半空，眼窝比人脸还宽——刚才那一下微震，是它在换气。"),
            line("yangxue", "文明历二〇五一，第十日险情日。金面数据早越过人间二〇二一——封土层照旧，先用微震声纹校准夯土。"),
            line("wangdun", "面具看胖爷我看面具——金牙刘你别在后面估价，估价声会干扰二〇五一的预警声纹！"),
          ],
        },
        epilogue: {
          title: "第二章 完 · 千面一神",
      ...
      },
      {
        ...
        prologue: {
          title: "第三章 · 神树通天",
          lines: [
            line("chenli", "文明历二〇五一，神树层位自己往上升——青铜神树高近四米，九枝九鸟。棋盘是缩微神树，连凌晨微震都被超越期读成枝杈应力。"),
            line("hutan", "连消等于「通脉」。连击越高，得分加成越大——进化引擎会记住你的节奏。"),
            line("wangdun", "胖爷我在树根发现玉璋！绳子扎牢再消，今天要消出一条不塌的通天路！"),
          ],
        },
        epilogue: {
          title: "第三章 完 · 树顶金沙",
    ...
    winQuotes: [
      ...
      { who: "王墩", text: "漂亮！胖爷今晚加鸡腿，冷粥就留给刘哥压惊。" },
      { who: "杨雪", text: "记录完美，可以写进 2051 微震预警版新坑报告。" },
      { who: "金牙刘", text: "这手气，刘哥我都想跟你合伙——先声明我没踩塌绳包。" },
    ],
    failQuotes: [
