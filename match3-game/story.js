    ...
    chapters: [
      {
        ...
        prologue: {
          title: "第一章 · 青铜门启",
          lines: [
            line("chenli", "胡探，文明历二〇四七——超越期第八日。新坑线压在昨夜复盘之后，此间古蜀知识比人间快两倍，今天从浅灰土重新开口。"),
            line("hutan", "罗盘刻度一早就醒了。偏南四度，地下金声像隔着雾敲碗——不是凶，是新坑在催我们轻点下铲。"),
            line("wangdun", "胖爷困得把铲子当锅铲了！先消表层陶片，金牙刘你别把样本袋当早点袋。"),
            line("yangxue", "第八日晨班规则：消除同类文物等于完成层位记录。四连生成「条纹圣物」，五连是「爆破符印」——先校准层位眼镜再动手。"),
          ],
        },
        epilogue: {
          title: "第一章 完 · 门缝里的光",
        ...
        beats: {
          ...
          5: [line("wangdun", "五层了！地下金属回响越来越响，像有人敲早饭铃——胖爷是真饿。")],
          10: [line("yangxue", "十层记录完成。陶片下出现象牙饰——新坑湿度偏高，别漏消，也别让晨雾进样本袋。")],
