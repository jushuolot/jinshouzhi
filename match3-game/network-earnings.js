...
(function () {
  ...
  var CONFIG = {
    ...
    newPitArchive: { amount: 0.019, phases: ["超越期"], universeDayMod: 1 },
  ...
  function tryNewPitArchive() {
    ...
    saveState();
    return creditChannel("new_pit_archive", {
      amount: cfg.amount,
      meta: {
        kind: "new_pit_archive",
        universeDay: uday,
        phase: phase,
        year: clock ? clock.getCivilizationDate().civilizationYear : 0,
      },
    });
  }
