...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四九——第九日，拌嘴校勘。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四九。公开文物图鉴与坑内编号今晨重新对齐，王墩和刘哥的口供也要编号。", "calm"),
        L("chenli", "昨夜雨停，资料室灯没熄。今天又是新的一日——古蜀知识继续跑在人间之前，营地吵得像开小型学术会。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇四九的新坑资料室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地听他们吵完。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四九了，超越期。金声从东北角来，比人间二〇二一还急了整整一轮半。", "focus"),
          L("yangxue", "第九日拌嘴校勘：层位图要按二〇四九标准记。公开资料里的纵目面具，已和坑内序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩把煎饼塞进样本袋，说这叫补给学。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背新坑第一铲和他的嘴。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷吃胖爷煎饼还说是文物风干。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四九新编号，尤其别拿编号夹煎饼。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四九，第九日拌嘴校勘。神树残件已定位——此间树高四米，人间论文还在补脚注。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四九的脉比人间快，脉通了，层位才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四九新坑神树层位——拌嘴声中的超越期校勘》。", "polite"),
