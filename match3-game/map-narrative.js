...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，第八日的雨刚停。"),
        L("yangxue", "人间还在整理二〇二一新坑，此间层位图已叠到二〇四七。今天晨会把神树根系和公开文物图鉴重新对齐。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。周一该下新坑，大家把早饭端稳，别把陶片编号溅上豆浆。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新坑探方。文明历二〇四七，入口仍然先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；第八日第一铲要写进晨会纪要。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一新坑还急半拍。", "focus"),
          L("yangxue", "周一下新坑：层位图要按二〇四七标准记。公开资料里的纵目面具，已和坑内新扫描序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩嫌早饭少，跟刘哥一早吵三回了。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，杨雪背扫描仪。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早少给胖爷盛半碗粥。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。文明历二〇四七的新坑层位很脆，请各位别乱动。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "周一的新坑一层一层向下。每一层都是一段被二〇四七文明历快进过的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在新坑晨会里对过一遍——此间坑内的，比人间档案还新一整代。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又偷吃火腿。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑晨会。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七新坑神树层位——此宇宙比人间快进一百一十八年》。", "polite"),
