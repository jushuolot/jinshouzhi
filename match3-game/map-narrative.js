...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——第八日清晨，雨后新坑格网铺满营地。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴和新坑测绘表同屏校验。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。周一下新坑，超越人间的那两年就落在这一铲。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。文明历二〇四七的新坑编号已下发，入口仍先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一新坑还急两拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图按二〇四七标准记。公开资料里的纵目面具，已和坑内序列二次对齐。", "calm"),
        ...
        assembly: [
          ...
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早新坑包子少了一个。", "grin"),
        ...
        routeIntro: "探方一层一层向下。文明历二〇四七的新坑格网里，每一层都是一段被压碎的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里复核过一遍——此间坑内的，比人间档案还新一轮。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又偷吃包子。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑复核。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七新坑神树复核——此宇宙比人间快两圈》。", "polite"),
