...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，新雨把封土洗出一条北线。"),
        L("yangxue", "人间还在追读二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴与今天的新坑编号重新合表。", "calm"),
        L("chenli", "第八日，下新坑。豆花摊刚收火，探照灯已经亮了——今天要让纵目北线说话。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。雨水刚退，入口已提速——先进图、后立绘，别在豆花摊旁干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从纵目北线来，比人间二〇二一的新坑记录还急半拍。", "focus"),
          L("yangxue", "第八日：层位图要按二〇四七标准记。公开资料里的纵目面具，今天要和雨后坑线二次校准。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有看住王墩，他刚把咸豆花说成考古补给。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是早餐学术辩论！策划完了就集合——刘哥背水壶，别背价目表。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日下新坑，此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁踩泥谁请客——刘哥你请，早上偷喝胖爷豆浆。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别把雨泥带进样本袋。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我复核二〇四七层位。", "warn"),
          L("narrator", "五人影没入雨后探方。风里还有豆花香，地下，有光。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是雨水洗亮的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又对过一遍——雨后坑内的，比人间档案还新整整一轮。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又偷喝豆浆。", "bold"),
      ...
      },
      {
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快两圈》。", "polite"),
