...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，新一周又开新坑。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴继续对齐 Wikimedia Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天第八日，旧营地炉火未灭，新坑的测线已经拉直。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "清晨的新坑还带着雾。第一层陶片下，有金属在呼吸，王墩的包子也在冒热气。",
        ...
        briefing: [
          ...
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急半拍。", "focus"),
          L("yangxue", "第八日开坑：层位图要按二〇四七标准记。公开资料里的纵目面具，只能参照，不能替代现场记录。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩跟刘哥为最后一个热包子吵了半路。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是能量分配会议！策划完了就集合——刘哥背方便面，包子归我。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "扛包开路归胖爷。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿。", "grin"),
        ...
        routeIntro: "探方一层一层向下。文明历二〇四七的新坑，每一层都是一段被压碎又被重新读出的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
