  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和头灯闪频今晨重新对齐。", "calm"),
        L("chenli", "午后雷云压低，资料室灯没熄。坑壁渗水、绳结复查和神树符号，被合进今天的超越期险情档案。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的险情档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别让雷雨堵在营地。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，渗水声也从东北角来，比人间二〇二一还急一轮。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑内头灯闪频重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有防水！王墩把编号签塞进姜茶盒，说这叫应急分类。", "nervous"),
          L("wangdun", "胖爷跟刘哥今天不吵，先系绳！策划完了就集合——刘哥背防水袋，我背第一铲和双份绳结。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕渗水谁请客——刘哥你请，今早把胖爷绳结当金链估价。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号、湿度贴和头灯记录。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风没停，地下的光先闪了三下。", "dramatic"),
        ],
        routeIntro: "探方一层一层向下。每一层都是一段被压碎的时间，也是一条要复查的安全线。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也更潮。", "serious"),
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于震落覆盖的夯土，也等于确认渗水线。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的险情预警。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，通绳我肯定行——刘哥别又拿防水袋当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一，第十日险情日。神树残件已定位——此间树高四米，人间论文还在补脚注，我们先补排水沟。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，层位和渗水线才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇五一险情巡更与神树层位——此宇宙比人间再多走两年》。", "polite"),
