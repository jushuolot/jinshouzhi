...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——宇宙第八日，新坑又开一线。"),
        L("yangxue", "人间还在反复校读二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴和昨夜手记都同步了。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。队里睡了半宿，土却多走两年——今天下新坑。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。文明历二〇四七，入口照旧先进图、后立绘，别让首屏陪我们熬夜。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；今天第一铲尤其要稳。", "serious"),
          L("hutan", "罗盘针直颤——第八日了，超越期。金声从东北角来，比人间新坑报告还急半拍。", "focus"),
          L("yangxue", "二〇四七标准：层位图、公开图鉴、新坑手记三份互校。纵目面具若提前出现，先拍照再消除。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有递编号牌！王墩一早把饭盒扣我包上了。", "nervous"),
          L("wangdun", "胖爷那叫防丢。策划完就集合——刘哥背方便面，胡探背罗盘，我背这口新坑气。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日新坑，只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还欠早饭。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。二〇四七层位表已同步，请各位别让铲尖抢在编号前面。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！今天保证只摸饭盒，不摸文物。", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我复核新坑手记。", "warn"),
          L("narrator", "五人影没入探方。风停了。第八日的地下，有光。", "dramatic"),
        ],
        routeIntro: "第八日新坑一层一层向下。每一层都是比人间快两年的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里对过一遍——此间坑内的，比人间档案又新两代。", "serious"),
          L("yangxue", "宇宙第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？第八日了，通不通我不知道，通坑我肯定行——刘哥别又偷吃火腿。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑回望。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——第八日新坑回声》。", "polite"),
