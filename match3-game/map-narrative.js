  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和夜巡声纹今晨重新对齐。", "calm"),
        L("chenli", "昨夜神树坑低频铜鸣，资料室灯没熄。那段险情声纹，成了超越期安全档案的第一条索引。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的安全档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，比人间二〇二一还急了整整一轮。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑内警戒声纹序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有守夜！王墩把冷馒头塞我包里，说这叫险情补给。", "nervous"),
          L("wangdun", "胖爷那是实战准备！策划完了就集合——刘哥背录音笔，我背安全档案第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨夜警报响时你抱着馒头跑得最快。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号、录音笔和声纹标尺。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代。", "serious"),
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于震落覆盖的夯土，也是在排除险情。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的警戒线。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，通坑我肯定行——刘哥别又拿编号签当报警符。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一，第十日险情日。神树残件已定位——此间树高四米，人间论文还在补脚注。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，昨夜铜鸣才不会乱成真险。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇五一险情声纹与神树层位——此宇宙比人间再多走两年》。", "polite"),
