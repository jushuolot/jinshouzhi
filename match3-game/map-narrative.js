...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——第八日清晨，雨水把新坑边线洗得发亮。"),
        L("yangxue", "人间还在反复校读二〇二一新坑，此间层位图已叠到二〇四七。今天我把开放数据引用贴到第一块层位牌上。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。昨夜刚复盘完，今晨又开新坑——超越期也得先把泥水擦干净。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，第八日新坑只批二十层。入口已提速——先进图、后立绘，别在雨棚下干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急整整一段层位。", "focus"),
          L("yangxue", "第八日：层位图按二〇四七标准记。公开资料里的纵目面具，今天要和新坑第一铲互证。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有擦泥！王墩一早把豆花汤洒我图录上了。", "nervous"),
          L("wangdun", "胖爷那是测试防水！策划完就集合——刘哥背方便面，我背新坑第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日新坑，只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕雨谁请客——刘哥你请，昨晚偷吃胖爷火腿。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七层位牌。", "polite"),
