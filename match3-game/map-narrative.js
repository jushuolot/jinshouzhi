...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇五三——第十一日，馋嘴/生活日。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和营地补给回执今晨重新对齐。", "calm"),
        L("chenli", "凌晨雨泥回潮，资料室灯没熄。胡探守着青铜门缝，王墩守着姜汤锅，炊烟微粒成了古蜀生活面貌的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等面条坨掉。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，警报先撤人。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还急；锅里姜汤倒也挺稳。", "focus"),
          L("yangxue", "第十一日馋嘴/生活日：层位图要按二〇五三标准记。公开资料里的纵目面具，已和补给回执、炊烟微痕重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴豌豆面碗上，我这回真只拍照。", "nervous"),
          L("wangdun", "胖爷今天先护锅再护坑！策划完了就集合——刘哥背方便面，我背应急灯、第一铲和二〇五三回执。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先别请，胖爷的姜汤锅也得有人背。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、补给回执和光谱尺。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也多了一页生活采样。", "serious"),
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要把炊烟干扰扣掉。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五三的罗盘说：古蜀人透过它看的，是还没写进人间论文的烟火日常。", "focus"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴/生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地炊烟先飘进数据。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，树根和灶火的微痕才分得清。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记生活烟尘与礼器磨痕。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，反正今天先保人。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇五三营地烟火与神树层位——此宇宙比人间再多走两年》。", "polite"),
