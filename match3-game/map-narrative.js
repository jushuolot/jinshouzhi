...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，第八日晨雾压着新坑。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴与新坑扫描在营地小桌上同步。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天换坑位，先看土色，再听人话——别让快进把细节甩掉。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了新坑早班二十层探方。入口继续提速——先进图、后立绘，晨雾散前就要开第一层。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；二〇四七的扫描也要服从土色。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比昨天更近，像新坑自己翻了个身。", "focus"),
          L("yangxue", "宇宙第八日：层位图按二〇四七标准记。公开资料里的纵目面具，已和新坑第一批点云对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有叫醒王墩，他把半碗稀饭当文物编号了。", "nervous"),
          L("wangdun", "胖爷那叫低血糖学术现象！策划完了就集合——刘哥背方便面，我背新坑工具箱。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日换新坑，此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还抢稀饭。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。二〇四七的点云我带了，请各位别乱动层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入新坑。晨雾贴着探照灯，地下，有光先醒。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是一段被晨雾压住的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又校了一遍——此间坑内的，比人间档案还新一圈。", "serious"),
          L("yangxue", "宇宙第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又抢早饭。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑回灌。神树残件已重算定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快两圈半》。", "polite"),
