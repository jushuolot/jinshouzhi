  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和营地补给清单今晨重新对齐。", "calm"),
        L("chenli", "凌晨雨泥回潮，资料室灯没熄。胡探守着青铜门缝，王墩守着锅，陶盉残片成了古蜀生活模型的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别等灶台凉了。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，饭前饭后都要洗手套。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还急了两轮，却偏偏带点锅气。", "focus"),
          L("yangxue", "第十一日馋嘴日：层位图要按二〇五三标准记。公开资料里的陶盉、象牙和纵目面具，今天都要补上生活用途注释。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴泡面盖上，我这回真只闻味儿。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背方便面，我背应急灯、第一铲和回锅肉。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先请胖爷看锅，别让补给汤洒进探方。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、补给贴和录音笔。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要记录饭后回潮。", "calm"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地灶烟已经先入档。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，饭香和回压点都不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记生活层位和补给曲线。", "calm"),
