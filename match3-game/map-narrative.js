...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——第八日晨雾压着新坑。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已推到二〇四七。公开文物图鉴对齐 Commons 档案，今天重点开新坑。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。王墩惦记热豆花，胡探却先把罗盘铜针换了。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "晨雾后的新坑像刚翻开的档案。第一层陶片下，有金属在呼吸。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，省里批了二十层新坑。入口继续提速——先进图、后立绘，别在营地等立绘加载。", "serious"),
          L("chenli", "胡探，你是领队。文明历二〇四七的层位仪刚校准，进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比昨天更像一扇门在醒。", "focus"),
          L("yangxue", "第八日新坑：层位图按二〇四七标准记。公开资料里的纵目面具，已和坑内序列做二次校验。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有看住王墩的热豆花，免得他把样品袋当饭盒。", "nervous"),
          L("wangdun", "胖爷跟豆花那是战友情！策划完了就集合——刘哥背方便面，我背新坑第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早热豆花被你碰凉了。", "grin"),
