...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跑到二〇四一——古蜀知识越过人间当下。"),
        L("chenli", "周五线索爆发，入口仍保持快：先进堪舆图，立绘随后到。雨夜灯组别停，符号谱系今晚要补一列。"),
        L("narrator", "五条探方线路，对应五段被掩埋的记忆。你选的不是关卡，是一段在超越期里刚醒过来的历史。"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四一，省里批的二十层探方升级为符号复核。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；雨水扰层也要记。", "serious"),
          L("hutan", "罗盘偏南三度，指针像在快进——金声从东北角来。不凶，是那半句古蜀话在等。", "focus"),
          L("yangxue", "我会负责层位图与文物序列。每消除一组同类器物，等于完成一条记录线。", "calm"),
        ...
        routeIntro: "探方一层一层向下。每一层都是一段被压碎的时间，今晚的超越期线索从泥水里往上冒。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "百关最后一程。超越期给出的符号读法不再只是猜测；墙后无退路，归档完成，全队撤出。", "serious"),
