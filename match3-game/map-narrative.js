  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和营地伙食记录今晨重新对齐。", "calm"),
        L("chenli", "雨泥退了，资料室灯还没熄。胡探守青铜门，王墩守灶台，烟火味成了古蜀生活层位的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别让灶火拖住首屏。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，吃饭先洗手。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还急，倒像在催王墩开锅。", "focus"),
          L("yangxue", "第十一日馋嘴生活日：层位图要按二〇五三标准记。公开资料里的陶盉，今天和营地茶壶一起编号。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴饭盒上，我这回真不跟他吵。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背方便面，我背应急灯、第一铲和热汤。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天真请，胖爷锅里还温着半盆回锅肉。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、饭盒签和录音笔。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要把饭盒远离样本袋。", "calm"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地茶汽已经先到。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，灶台烟也顺着神树纹往上走。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记生活层位和天气曲线。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，热汤不洒也算胖爷赢，反正今天先保人再加饭。", "grin"),
        ],
