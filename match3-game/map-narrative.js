...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇五三——第十一日，馋嘴生活日。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和营地炊烟粒子今晨重新对齐。", "calm"),
        L("chenli", "午后热雨落得急，资料室灯没熄。胡探守着青铜门缝，王墩守着锅，补给账本成了古蜀生活层位的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活层位档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等饭凉。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，吃饭先洗手，警报先撤人。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还急，锅里的辣油也急。", "focus"),
          L("yangxue", "第十一日馋嘴生活日：层位图要按二〇五三标准记。公开资料里的纵目面具，今天和炊烟粒子、稻壳样本一起对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把补给编号签贴饭盒上，我这回真不跟他吵。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背方便面，我背应急灯、第一铲和那口锅。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天可以请，账记营地补给本，别记在文物编号上。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、花粉采样袋和我的饭盒标签。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。热雨停了。地下有光，营地锅里也有香。", "dramatic"),
        ],
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也多了一页营地生活注释。", "serious"),
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要记录热雨后炊烟落尘。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五三的罗盘说：古蜀人透过它看的，是还没写进人间论文的生活线。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五三了，通不通我不知道，通坑我肯定行——刘哥别把安全绳当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，我们先把花粉与灶灰样本编号。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，树根里的稻壳与青铜锈才说得清。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记花粉谱、热雨和营地炊烟。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，饭点前回来更算胖爷赢。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇五三营地炊烟与神树层位——此宇宙比人间又多走两年》。", "polite"),
