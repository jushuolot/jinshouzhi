  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和陶盉温痕今晨重新对齐。", "calm"),
        L("chenli", "雨后营地烟火没散。胡探守青铜门，王墩守豆花锅，炊烟里的微量灰烬成了古蜀生活档案的新旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，热饭别等凉。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，吃饱也别乱步。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还多走了三十二年。", "focus"),
          L("yangxue", "第十一日馋嘴生活日：层位图要按二〇五三标准记。Wikimedia 公开图里的陶盉，今天用来对照温痕和炊烟灰。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴豆花碗上，我这回真不跟他抢。", "nervous"),
          L("wangdun", "胖爷今天先盛两碗！策划完了就集合——刘哥背调料，我背应急灯和第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先请热豆花，胖爷手暖了才好拉绳。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、炊烟灰样和录音笔。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也更像看见营地烟火。", "serious"),
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要保留生活层炭粒。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五三的罗盘说：古蜀人透过它看的，是还没写进人间论文的日常炊烟。", "focus"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，树下灶灰已经先入档。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，炊烟和树影才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记生活层灰样。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，豆花不洒也算胖爷赢，反正今天先稳手。", "grin"),
        ],
