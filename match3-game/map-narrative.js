...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，小雨把新坑边线洗得发亮。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴也与 Wikimedia Commons 档案同步归档。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天下新坑——超越人间的那一铲，要按二〇四七标准记录。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七，省里批了新坑二十层探方。入口继续提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，今日每袋土都挂第八日标签。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急了三拍。", "focus"),
          L("yangxue", "新坑晨工：层位图按二〇四七标准记。Commons 公开图里的纵目面具，已和坑内序列对齐到小数点。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩跟刘哥一早为第一铲归谁吵三回了。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，第一铲归胖爷。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还抢新坑第一铲。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七的层位标签。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑晨工。神树残件已重新定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题又改了：《二〇四七新坑晨工——此宇宙比人间快到需要新表格》。", "polite"),
