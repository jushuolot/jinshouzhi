...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——宇宙第八日，新坑红线在雨后重新拉直。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。昨夜复盘的神树数据，今早就接进了新坑索引。", "calm"),
        L("chenli", "屏外的昼夜过去，宇宙没停。今天不是换皮，是队伍睡醒后又多活的一天。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新坑探方。入口继续提速——先进图、后立绘，别让雨后泥气堵住首屏。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：新坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从北移半尺的新红线下冒出来，比昨夜神树复盘还急。", "focus"),
          L("yangxue", "宇宙第八日：层位图要按二〇四七标准记。公开资料里的纵目面具，已和今日新坑索引对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有把探方牌举正，王墩刚才举反了三秒。", "nervous"),
          L("wangdun", "胖爷那叫反向校准！策划完了就集合——刘哥背热水，别再拿方便面当样本袋。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还把新坑线踩歪。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七的新层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "第八日的新坑一层一层向下。每一层都是一段被雨水泡软、又被记录压实的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在新坑索引里又对过一遍——此间坑内的，比人间档案还新一整代。", "serious"),
          L("yangxue", "宇宙第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又踩新坑红线。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日下新坑。神树残件昨夜已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七新坑神树层位——此宇宙每夜快进两年》。", "polite"),
