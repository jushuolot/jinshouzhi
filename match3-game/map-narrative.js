  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和凌晨微震曲线今晨重新对齐。", "calm"),
        L("chenli", "资料室灯没熄，三号坑预警灯也没灭。王墩给金牙刘递了半碗冷粥，嘴上还说是怕他抖坏录音笔。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的险情预警室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，比人间二〇二一还急了整整两轮。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑内微震序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有报警！王墩把绳包枕了一夜，说这叫人肉防塌。", "nervous"),
          L("wangdun", "胖爷那是守夜！策划完了就集合——刘哥背方便面，我背预警档案第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕塌方谁请客——刘哥你请，今早把胖爷冷粥当祭祀灰。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号和微震笔记。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新两代。", "serious"),
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于把微震能量安全放掉。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的危险。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，通风绳我肯定系牢——刘哥别又拿编号签当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，微震才有地方泄。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇五一微震预警与神树层位——此宇宙比人间再多走两年》。", "polite"),
