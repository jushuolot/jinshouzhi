  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、坑内编号和营地灶台潮气今晨重新对齐。", "calm"),
        L("chenli", "凌晨雨泥回潮，资料室灯没熄。胡探守门，王墩守锅，热气成了古蜀符号日常模型的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的日常档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别让早饭凉在营地。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，热饭也要离探方编号远一点。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，灶台热气从西南角来，今天两边都要稳。", "focus"),
          L("yangxue", "第十一日馋嘴生活日：层位图要按二〇五三标准记。公开资料里的纵目面具，已和营地潮气曲线重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴抄手碗上，我这回真不跟他吵。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背辣椒面，我背应急灯和第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先别请，胖爷还惦记锅里那碗热抄手。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、湿度贴和我的饭盒记录。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。营地锅盖还轻轻响着。地下，有光。", "dramatic"),
        ],
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也更懂雨后营地。", "serious"),
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要避开灶台潮气干扰。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五三的罗盘说：古蜀人透过它看的，是还没写进人间论文的日常线。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五三了，通不通我不知道，通坑我肯定行——刘哥别把安全绳当抄手挂面。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地潮气已经先成样本。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，锅里红油也别洒进样本袋。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记潮气曲线。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，回营还能吃热的更算赢。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇五三营地潮气与神树层位——此宇宙比人间再多走两年》。", "polite"),
