...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，比人间快两倍。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已把浅灰新坑线叠到金面数据之后。公开文物图鉴也对齐了 Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。昨夜收工复盘，今晨下新坑——队员困，层位不困。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七第八日，省里把浅灰新坑线批下来了。入口继续提速——先进图、后立绘，别在晨雾里干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；今天还要同步金面数据。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七的超越期。金声从东北角来，像比人间新坑又多问了一个问题。", "focus"),
          L("yangxue", "第八日晨班：层位图按二〇四七标准记。公开资料里的纵目面具，已和新坑灰线序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有咖啡！王墩把样本袋当早点袋这事我先备案。", "nervous"),
          L("wangdun", "胖爷那是测试样本袋承重！策划完了就集合——刘哥背咖啡，别背估价单。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。文明历二〇四七第八日，此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕晨雾谁请客——刘哥你请，昨晚偷喝胖爷咖啡。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动层位眼镜。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，先把新坑灰线闭合。", "warn"),
          L("narrator", "五人影没入第八日的新坑。风停了，晨雾还挂在绳索上。地下，有光。", "dramatic"),
        ],
        routeIntro: "第八日新坑一层一层向下。每一层都是一段刚从晨雾里醒来的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
