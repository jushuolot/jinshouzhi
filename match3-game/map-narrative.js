...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期又向前滚了两年。"),
        L("yangxue", "人间还在整理新坑数据，此间层位图已叠到二〇四七。昨夜的公开图鉴，今天成了新坑索引。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。第八日雨停半刻，我们下新坑，按新的符号表重记第一层。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，第八日的新坑批了二十层探方。入口仍按快速加载走：先见地图，再补立绘，别让雨后潮气把人等蔫。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；今天多加一条，先核二〇四七索引。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比昨晚的神树回声更靠近门缝。", "focus"),
          L("yangxue", "今日层位图按二〇四七标准记。公开资料里的纵目纹，已经被压缩成新坑第一层的符号索引。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！王墩一早把雨披穿反了，我还没笑够呢。", "nervous"),
          L("wangdun", "胖爷那叫倒穿防盗！策划完就集合——刘哥背索引板，别只背方便面。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日开新坑，照旧只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚把胖爷雨靴藏哪了？", "grin"),
          L("yangxue", "杨雪，哈佛考古系。今天请先看索引板，再碰层位；二〇四七的符号表比昨天细。", "polite"),
          L("jinyaliu", "金牙刘，官方顾问兼雨披纠错员。顾问！真是顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我重新核索引。", "warn"),
          L("narrator", "五人影没入新坑。风停了半刻。地下，有光，也有昨夜没睡完的人声。", "dramatic"),
        ],
        routeIntro: "第八日的新坑一层一层向下。每一层都是一段被雨水压软、又被文明历加速的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新几代。", "serious"),
          L("yangxue", "第八日新坑：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又藏雨靴。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日下新坑。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，脉通了，层位才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快到超越》。", "polite"),
