  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑余波，此间层位图已叠到二〇四七。公开文物图鉴、Commons 档案和坑内泥水一起并表。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天他们没睡够，也照样把文明往前推了两年。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了雨后新坑的二十层探方。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期第八日。金声从东北角来，比昨晚复盘又深了半尺。", "focus"),
          L("yangxue", "今日标准：所有层位按二〇四七归档。新坑 7、8 的金面线索，先和坑口泥样对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩一早说我偷吃早饭，我只偷看了菜单。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——下新坑前谁背方便面谁有话语权。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今天早饭账还没清。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七新坑层位。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里对过两轮——此间坑内的，比人间档案还新一整代。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又偷看菜单。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日下新坑。神树残件已定位——此间树高四米，人间论文还在追三米的旧稿。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，脉通了，雨后层位才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日和新坑泥样一起重点记。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，爬不到……也算胖爷赢，反正我尽力。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题又改了：《二〇四七雨后神树层位——此宇宙比人间快两倍》。", "polite"),
