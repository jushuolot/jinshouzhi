...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第二圈，新坑雾线压着河风。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴仍按 Wikimedia 档案校对。", "calm"),
        L("chenli", "昨夜收工的灰还没扫净，今天又开一条坑线。文明走得快，人得慢慢下铲。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。入口仍按轻量加载走——先进图、后立绘，别让营地等三维模型。", "serious"),
          L("chenli", "胡探，你是领队。文明历二〇四七的新坑线刚测完，进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一的新坑还急半拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图按二〇四七标准记。公开资料里的纵目面具，今晚要和坑内序列重校。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩说热豆浆比罗盘重要。", "nervous"),
          L("wangdun", "胖爷那叫保持体力！策划完了就集合——刘哥背豆浆，别又背成古玩包。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷喝胖爷豆浆。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入新坑。雾还没散，地下先亮了一点铜色。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是文明历二〇四七写给旧土的旁注。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一条坑线。", "serious"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑测绘。神树残件已重新定位——此间树高四米，人间论文还在写三米。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，脉通了，新坑层位才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今晚重点复测。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，爬不到……也算胖爷赢，反正我尽力。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇四七神树新坑复测——此宇宙比人间快两圈》。", "polite"),
