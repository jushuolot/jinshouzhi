...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇五三——第十一日，馋嘴日。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五三。公开文物图鉴、炭屑温度和营地饭点录音今晨重新对齐。", "calm"),
        L("chenli", "雨停后灶火重开，资料室灯没熄。胡探守门，王墩守锅，炊烟成了古蜀生活档案的新旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，灶火别熄。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，饭熟先分给守夜的人。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，竹筒饭香从西南角来，两边都不能误。", "focus"),
          L("yangxue", "第十一日馋嘴日：层位图按二〇五三标准记。公开资料里的纵目面具，今天要和灶火炭屑一起校准。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴泡面盖上，我只负责把盖子拿远。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背方便面，我背应急灯、第一铲和一锅热汤。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天我请竹筒饭，但坑壁一响先拉人后盛饭。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五三新编号、炭温贴和录音笔。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！顺便声明：锅边那块肉不是我夹走的。", "sheepish"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也更懂烟火气。", "serious"),
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要采一份炭屑样。", "calm"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日馋嘴日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地炊烟已经先入档。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，树根炭屑和回压点才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记神树纹与灶火炭温。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，回营锅里还热也算胖爷赢。", "grin"),
        ],
