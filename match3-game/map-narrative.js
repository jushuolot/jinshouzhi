...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，比人间快到能预读新坑路线。"),
        L("yangxue", "人间还在整理二〇二一至二〇二二新坑，此间层位图已叠到二〇四七。公开文物图鉴与坑内符号同步到今日清晨。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。周一下新坑，先把昨夜雨水抽干，再让文明多走两年。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "雨后的新探方像一道刚揭开的伤疤。第一层陶片下，有金属在呼吸，也有糊粥味跟着下坑。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。二〇四七的新坑符号像在自己排队，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——超越期第八日。金声从东北角来，比人间新坑通报还急半拍。", "focus"),
          L("yangxue", "今日层位图按二〇四七标准记。纵目、神树、金面三套符号要同表比对，错一格全队重来。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩把粥煮糊了还说是铜锈采样。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是早餐事故！策划完了就集合——刘哥背编号牌，别背方便面。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，糊粥也是你先发现的。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动 2047 新坑编号。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是一段被压碎的时间，今日又被文明历推快两年。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一整代。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥先别偷吃火腿。", "bold"),
      ...
      },
      {
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙把新坑又读快两年》。", "polite"),
