...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，雨后新坑像刚醒的铜钟。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。声纹、公开图鉴与 Commons 档案今晨重新对齐。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天不是复盘，是下新坑——每一铲都要给文明历留坐标。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          ...
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急三拍，像有人在门后敲暗号。", "focus"),
          L("yangxue", "第八日下新坑：层位图要按二〇四七标准记。声纹里的二次回填，已和纵目面具序列对齐。", "calm"),
        ...
        assembly: [
          ...
          L("narrator", "五人影没入探方。雨停了，炉上剩汤还冒热气；地下，有光，也有新坑的回声。", "dramatic"),
        ],
