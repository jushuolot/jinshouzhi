...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跑到二〇三三——复兴期又比人间快走两年。"),
        L("chenli", "周五线索爆发：堪舆图先开，立绘后台到，田野笔记镜像已把七八号坑编号压进路线。"),
        L("narrator", "五条探方线路，对应五段被掩埋的记忆。你选的不是关卡，是一段正在被二〇三三复兴期读出的历史。"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。文明历二〇三三的镜像笔记刚到，先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，七八号坑编号要逐层核对。", "serious"),
          L("hutan", "罗盘偏南三度，指针像在快进——金声从东北角来。不凶，是一条线索等得不耐烦。", "focus"),
          L("yangxue", "我会负责层位图与文物序列。每消除一组同类器物，等于完成一条二〇三三版记录线。", "calm"),
        ...
        assembly: [
          ...
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚把胖爷泡面端去压田野笔记。", "grin"),
