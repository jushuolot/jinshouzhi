...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，比人间快两倍。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴之外，今天多出一格新坑信号。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。周一清晨，小队带着冷馒头下新坑——超越人间的那一日。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。文明历二〇四七，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；新坑信号单独编号。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东偏北来，比人间二〇二一还急三拍。", "focus"),
          L("yangxue", "第八日周一：层位图要按二〇四七标准记。公开资料里的纵目面具，已和坑内序列对齐，新坑暂列 X-08。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩跟刘哥为早饭包子吵三回了。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背新坑工具袋。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携；二〇四七新坑先听罗盘，再听人声。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，早饭偷吃胖爷火腿。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动 X-08 层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下的新坑信号，像刚醒的灯。", "dramatic"),
        ],
        routeIntro: "探方一层一层向下。每一层都是二〇四七超越期多读出的一段时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里对过一遍——此间坑内的，比人间档案还新整整一代。", "serious"),
          L("yangxue", "超越期第八日：封土层按二〇四七标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四七的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四七了，通不通我不知道，通坑我肯定行——刘哥别又偷吃早饭。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑开局。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快两倍》。", "polite"),
