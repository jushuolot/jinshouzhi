...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，新一圈从雨后新坑开始。"),
        L("yangxue", "人间还在整理二〇二一后的新坑资料，此间层位图已叠到二〇四七。公开文物图鉴、金面测绘和神树遥测同屏校准。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。昨夜收工复盘，今晨下新坑——热豆浆还冒气，记录板已经开机。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "雨后的探方像一道被揭开的伤疤。文明历 2047 的第一层陶片下，有金属在呼吸。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，文明历二〇四七，新一圈第一坑批了二十层探方。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急半拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图按二〇四七标准记。金面、神树、象牙微痕三组数据今天一起跑。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩一早把豆浆挂我探杆上，说这叫热启动。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，豆浆算公共资产。", "bold"),
        ],
        ...
        routeIntro: "探方一层一层向下。文明历 2047 的新坑，每一层都是被快进又重新压实的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
