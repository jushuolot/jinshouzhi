...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，比人间又快进两年。"),
        L("yangxue", "人间还在反复整理二〇二一新坑，此间层位图已经叠到二〇四七。公开文物图鉴继续对齐 Wikimedia Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。第八日清晨雾重，新坑编号已经写上木牌。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七第八日，新坑只批二十层。入口继续提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，今天先记雾水方向。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比昨晚收工复盘又深一尺。", "focus"),
          L("yangxue", "第八日新坑：层位图按二〇四七标准记。公开资料里的纵目面具，已和坑内新序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有保管冷馒头！王墩别瞪我，今天我不碰金粉。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是早餐协商！策划完了就集合——刘哥背水壶，方便面今晚再说。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早冷馒头少了半个。", "grin"),
        ...
        routeIntro: "第八日新坑一层一层向下。每一层都是文明历二〇四七被压碎的清晨。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新两代。", "serious"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑复测。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快两圈之后又两年》。", "polite"),
