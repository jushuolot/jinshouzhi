...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——第八日雨后下新坑。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴继续对齐 Wikimedia Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天新坑外沿露出一线青铜，超越期又多走了两年。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。入口仍按轻加载流程走——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。文明历二〇四七，地下情况比昨晚更清楚也更快，进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针不抖了，像一夜没睡终于想明白。金声从青铜门外侧来，比人间二〇二一还急两个文明年。", "focus"),
          L("yangxue", "超越期第八日：层位图要按二〇四七标准记。公开资料里的纵目面具，继续和坑内序列做交叉校验。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有保管王墩早饭，免得他把油纸包埋进新坑。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——方便面今天按探方编号发。", "bold"),
        ],
        ...
        routeIntro: "探方一层一层向下。第八日的新泥还潮，每一层都是一段被雨水重新冲亮的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑数据回流。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，脉通了，层位才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今天按新坑雨痕重新标注。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，爬不到……也算胖爷赢，反正我尽力。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇四七神树层位——新坑雨痕与超越期回流》。", "polite"),
