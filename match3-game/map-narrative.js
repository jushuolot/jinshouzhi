...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——一代两年，超越期仍在加速。"),
        L("yangxue", "人间还在追索新坑细节，此间层位图已经叠到二〇四七。公开文物图鉴与坑内传感数据今晚重新合档。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天下新坑，雨刚停，饭盒边还压着一张未编号的拓片。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。入口继续轻装——先进图、后立绘，今天别让雨后的泥拖慢首屏。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，二〇四七的编号不能乱。", "serious"),
          L("hutan", "罗盘针直颤——文明历二〇四七了，超越期。金声从东北角来，比人间二〇二一新坑还急一拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图要按二〇四七标准记。公开资料、传感网和昨夜复盘一起进档。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有保管饭盒，王墩一早把铲子放我粥碗旁边。", "nervous"),
          L("wangdun", "胖爷那是给粥加点青铜气！策划完了就集合——刘哥背方便面，别背假牙盒。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。二〇四七新坑，只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，早饭账还没结。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别碰我刚同步的新坑数据集。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "第八日的新坑一层一层向下。每一层都把 1929-07 之后的时间再快进两年。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
