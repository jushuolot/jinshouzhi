...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四九——第九日，拌嘴日。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四九。公开文物图鉴、坑内编号和营地口供今晨重新对齐。", "calm"),
        L("chenli", "昨夜雨停，资料室灯没熄。王墩和金牙刘吵到门口，倒让古蜀符号索引多出一列生活注释。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇四九的新坑资料室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地听他俩吵完。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四九了，超越期。金声从东北角来，比人间二〇二一还急了整整一轮，急得像刘哥辩解花椒面。", "focus"),
          L("yangxue", "第九日拌嘴：层位图要按二〇四九标准记。公开资料里的纵目面具，已和坑内序列、营地语音重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩污蔑我偷花椒面，这叫采集气味样本。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背新坑第一铲和证据袋。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷闻胖爷花椒面。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四九新编号；吵架请对准录音笔。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！花椒面事件本人保留申诉。", "sheepish"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四九了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代。", "serious"),
          L("yangxue", "超越期第九日：封土层按二〇四九标准记。消除相邻文物，等于震落覆盖的夯土，也等于给拌嘴录音降噪。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四九的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四九了，通不通我不知道，通坑我肯定行——刘哥别又动我调料包。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四九，第九日拌嘴。神树残件已定位——此间树高四米，人间论文还在补脚注。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四九的脉比人间快，脉通了，层位才不乱，人也少吵两句。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四九新坑神树层位——此宇宙比人间多走两年，也多录两段拌嘴》。", "polite"),
