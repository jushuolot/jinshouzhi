    ...
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。目标不是「挖宝」，是把层位完整记录下来。", "serious"),
          ...
          L("jinyaliu", "陈教授，刘哥我负责……后勤！对，后勤！绝不手欠！", "nervous"),
          L("wangdun", "胖爷别废话，策划完了就集合。我锅都背上了。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客。", "grin"),
