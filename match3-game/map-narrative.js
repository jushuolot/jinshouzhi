...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——雾从新坑边线往外淌。"),
        L("yangxue", "人间还在追问新坑细节，此间层位图已叠到二〇四七。Wikimedia 公开图鉴先开着，今天按实物纹理校准。", "calm"),
        L("chenli", "宇宙第八日，循环不是重播。今天下新坑，谁昨晚没睡好，谁就负责多记一遍编号。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七的新坑批下来了。入口仍按轻量图先开，立绘后台补，别让玩家在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；今天编号从东南角重排。", "serious"),
          L("hutan", "罗盘针不颤，反而像贴着坑沿呼吸。二〇四七的金声从东南角来，比人间论文还早两步。", "focus"),
          L("yangxue", "超越期第八日：层位图按二〇四七标准记。公开资料里的纵目面具，先和新坑陶片纹理交叉校验。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有热水！王墩嫌早饭太素，已经盯我包三分钟了。", "nervous"),
          L("wangdun", "胖爷那是关心补给安全！策划完了就集合——刘哥背热水，别背空话。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。二〇四七新坑，只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚那半根火腿还没交代。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动层位；今天每个编号都要拍照留底。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！我包里真只有热水和创可贴。", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我把新坑日志写完。", "warn"),
          L("narrator", "五人影没入探方。雾停在坑口。地下，像有人刚把灯点亮。", "dramatic"),
        ],
        routeIntro: "二〇四七的新坑一层一层向下。每一层都是一段被压碎、又被重新读出的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑简报已回传。神树残件仍在呼应——此间树高四米，人间论文还在写三米。", "serious"),
