  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和裂隙热像今晨重新对齐。", "calm"),
        L("chenli", "午后支护梁轻响三次，资料室灯没熄。王墩把泡面锅敲成警戒锣，也成了古蜀符号校读的时间戳。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的险情值守室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，比人间二〇二一还急了整整一轮。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑内裂隙声纹序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有避险！王墩把泡面锅扣头上，说这叫临时安全帽。", "nervous"),
          L("wangdun", "胖爷那是战术警戒！策划完了就集合——刘哥背方便面，我背险情档案第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕裂隙谁请客——刘哥你请，今早把胖爷锅盖当支护垫片。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号和热像标尺。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于震落覆盖的夯土，也等于复核裂隙边界。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的险情图谱。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，通风我肯定先测——刘哥别又拿编号签当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，裂隙预警才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇五一险情值守与神树层位——此宇宙比人间再多走两年》。", "polite"),
