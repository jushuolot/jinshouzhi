  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和支架潮气预警今晨重新对齐。", "calm"),
        L("chenli", "夜雨把探方边坡泡软，资料室灯没熄。今晚所有策划先过安全巡检，再谈下铲。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的险情巡检室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在支架下干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，比人间二〇二一还急，像提前敲安全锣。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑内潮气、支架声纹重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有扶支架！王墩把安全绳系成蝴蝶结，说这叫胖爷美学。", "nervous"),
          L("wangdun", "胖爷那是活扣！策划完了就集合——刘哥背方便面，我背险情巡检第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早差点把安全绳当金链揣兜。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号、潮气表和录音笔。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了一瞬，木撑轻轻响了一声。地下，有光，也有警告。", "dramatic"),
        ],
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新，连危险点都先一步发声。", "serious"),
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于震落覆盖的夯土，也等于测试支架响应。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的塌方前兆。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，安全绳我肯定先系紧——刘哥别又拿编号签当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一，第十日险情日。神树残件已定位——此间树高四米，人间论文还在补脚注，我们先补支点图。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，支架也要跟着稳。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇五一险情巡检与神树层位——此宇宙比人间再多走两年》。", "polite"),
