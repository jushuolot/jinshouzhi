...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇五一——第十日，险情日。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇五一。公开文物图鉴、坑内编号和坑壁湿度报警今晨重新对齐。", "calm"),
        L("chenli", "凌晨雨泥回潮，资料室灯没熄。胡探守着青铜门缝，警报声成了古蜀符号避险模型的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五一的避险档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，警报先撤人。", "serious"),
          L("hutan", "罗盘针直颤——二〇五一了，超越期。金声从东北角来，比人间二〇二一还急了整整一轮半。", "focus"),
          L("yangxue", "第十日险情日：层位图要按二〇五一标准记。公开资料里的纵目面具，已和坑壁湿度曲线重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有拉安全绳！王墩把编号签贴泡面盖上，我这回真不跟他吵。", "nervous"),
          L("wangdun", "胖爷今天少贫两句！策划完了就集合——刘哥背方便面，我背应急灯和第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先别请，坑壁报警时胖爷得腾手拉人。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇五一新编号、湿度贴和录音笔。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新一代，也更会报警。", "serious"),
          L("yangxue", "超越期第十日：封土层按二〇五一标准记。消除相邻文物，等于震落覆盖的夯土，也要避开回压点。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇五一的罗盘说：古蜀人透过它看的，是还没写进人间论文的险情线。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇五一了，通不通我不知道，通坑我肯定行——刘哥别把安全绳当餐券。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五一，第十日险情日。神树残件已定位——此间树高四米，人间论文还在补脚注，坑壁传感线已经先响。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五一的脉比人间快，脉通了，回压点才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记避险曲线。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，反正今天先保人。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "论文标题改了：《二〇五一坑壁险情与神树层位——此宇宙比人间再多走两年》。", "polite"),
