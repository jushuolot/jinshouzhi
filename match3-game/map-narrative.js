...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跑到二〇二九——比人间快了两倍。"),
        L("narrator", "五条探方线路，对应五段被掩埋的记忆。你选的不是关卡，是一段在快进中尚未被读出的历史。"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          ...
          L("hutan", "罗盘偏南三度，指针像在快进——金声从东北角来。不凶，是有人在等。", "focus"),
