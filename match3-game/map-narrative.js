...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，夜雨把新坑边线洗了出来。"),
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四七。公开文物图鉴、探针回波和坑内序列今天全要重对一遍。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今日下新坑，文明比人间快出的两年，先落在这一铲土上。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七批了二十层新探方。入口继续提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层；今日新坑先按探针回波排优先级。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间论文还早两年报到。", "focus"),
          L("yangxue", "超越期第八日：层位图要按二〇四七标准记。纵目、神树、金面三套数据，今晚得和坑内序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！王墩一早把冷馒头塞我包里，说新坑不能饿着下。", "nervous"),
          L("wangdun", "胖爷那叫战备粮！策划完了就集合——刘哥背方便面，别背古董。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕新坑谁请客——刘哥你请，昨晚偷吃胖爷火腿。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。二〇四七层位板已校准，请各位别乱动今日新坑标尺。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入第八日的新探方。风停了。地下，有光，也有刚醒的泥腥。", "dramatic"),
        ],
        routeIntro: "二〇四七新坑一层一层向下。每一层都是一段被压碎、又被超越期提前读出的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑连到神树残件——此间树高四米，人间论文还在写三米。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，脉通了，新坑回波才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七新坑回波与神树层位——此宇宙比人间快两圈》。", "polite"),
