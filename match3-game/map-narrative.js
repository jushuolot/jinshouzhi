  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四九。符号解读室今晨重新对齐公开文物图鉴与坑内编号。", "calm"),
        L("chenli", "昨夜雨停，帐篷漏水。王墩和金牙刘为一碗臊子面吵到天亮，古蜀知识也跟着跑在人间之前。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇四九的符号解读室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四九了，超越期。金声从东北角来，比人间当下还急了整整一轮。", "focus"),
          L("yangxue", "第九日拌嘴日：层位图要按二〇四九标准记。公开资料里的纵目面具，已和坑内序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩把臊子面塞进工具包，说这叫补给学。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背账本，我背新坑第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷吃胖爷煎饼。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四九新编号。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("wangdun", "胖爷听说纵目能通神？二〇四九了，通不通我不知道，通坑我肯定行——刘哥别又偷吃臊子面。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("hutan", "连消在风水上叫「通脉」。二〇四九的脉比人间快，脉通了，层位才不乱，嘴也别太乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四九新坑神树层位——此宇宙比人间继续多走两年》。", "polite"),
