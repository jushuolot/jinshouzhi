...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，新坑在雨后露出封土边。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴也对齐了 Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天第八日，队员早饭还没吃完，探方已经喊人了。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七的新坑批了二十层探方。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急三拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图要按二〇四七标准记。公开资料里的纵目面具，已和坑内序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩早饭没吃饱，已经盯我馒头十分钟。", "nervous"),
          L("wangdun", "胖爷那是保护文物现场的碳水安全！策划完了就集合——刘哥背方便面。", "bold"),
        ],
        ...
        routeIntro: "二〇四七的新探方一层一层向下。每一层都是一段被压碎的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在公开图鉴里对过一遍——此间坑内的，比人间档案还新一代。", "serious"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑接上旧树根。神树残件已定位——此间树高四米，人间论文还在写三米。", "serious"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七神树层位——此宇宙比人间快到新坑先开口》。", "polite"),
