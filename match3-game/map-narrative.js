...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，仍按两倍速度推着清晨往前走。"),
        L("yangxue", "人间还在整理新坑公开资料，此间层位图已叠到二〇四七。Wikimedia 实拍图鉴继续做对照，今天要核新坑边线。", "calm"),
        L("chenli", "雾没散，豆花摊先开了。造物主关屏走后，宇宙又过一夜——今天下新坑。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "清晨雾气压低探照灯。新坑边线像刚醒的伤口，第一层陶片下有金属在呼吸。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，省里批了二十层新探方。入口继续提速——先进图、后立绘，别让二〇四七的晨雾卡住队伍。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。今天编号从 GS-2047-08 开始。", "serious"),
          L("hutan", "罗盘针直颤——文明历二〇四七，超越期。金声从东北角来，比昨天更贴近纵目门槛。", "focus"),
          L("yangxue", "周一下新坑：层位图按二〇四七标准记。公开资料里的纵目面具，要和今天第一批陶片即时对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有豆花账！王墩说加蛋算科研补贴。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是营养学辩论！策划完了就集合——刘哥背方便面，别背估价册。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。二〇四七新坑，只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁第一铲挖空谁请豆花——刘哥你先把勺放下。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动 GS-2047-08 的层位标尺。", "polite"),
          L("jinyaliu", "金牙刘，官方顾问。今天我只背水和方便面，估价册封箱。", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我复核文明历编号。", "warn"),
          L("narrator", "五人影没入新坑。雾贴着地面退开，地下有一线青铜光。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是文明历二〇四七刚翻开的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
