...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——第八日清晨，新坑水汽贴着探方往上冒。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴与今天的新格网，刚在营灯下对齐。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。昨夜雨停后，我们把第一坑重新编号——今日下新坑。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历二〇四七的新坑批下来了。入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，雨水先舀净。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一还急好几拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图要按二〇四七标准记。公开资料里的纵目面具，已和今天的格网序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有看水桶！王墩跟刘哥一早为半包榨菜吵了三回。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背抽水泵。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今早还抢干袜子。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动文明历二〇四七的新坑层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "探方一层一层向下。文明历二〇四七的新坑里，每一层都是一段被雨水压亮的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
