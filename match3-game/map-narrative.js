  ...
  window.MATCH3_MAP = {
    ...
    chapters: [
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七，第八日新坑。神树残件已定位，反刻符号也对上树根榫眼——此间树高四米，人间论文还在写三米。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四七的脉比人间快，新坑脉通了，神树层位才不乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题又改了：《二〇四七新坑测线与神树层位——此宇宙比人间快两圈》。", "polite"),
