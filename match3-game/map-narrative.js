...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期第八日，新坑巡线铺到营地外。"),
        L("yangxue", "人间还在整理二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴也对齐了 Commons 档案。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天第二圈开铲，风向、伙食和队员脾气都和昨天不一样。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          ...
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从新坑一号口来，比人间二〇二一还急半拍。", "focus"),
          L("yangxue", "第八日下新坑：层位图要按二〇四七标准记。公开资料里的纵目面具，已和坑内新序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩说凉馒头归我，明明是他自己不想吃。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——新坑第一铲，谁迟到谁背方便面。", "bold"),
        ],
        ...
        routeIntro: "新坑一号口一层一层向下。每一层都是一段被压碎的时间，也是一口刚起锅的热气。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四七了。纵目面具在新坑支线又对过一遍——此间坑内的，比人间档案还新半代。", "serious"),
      ...
      },
      {
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四七新坑巡线与神树层位——此宇宙比人间快两圈》。", "polite"),
