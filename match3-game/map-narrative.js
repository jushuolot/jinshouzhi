  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("chenli", "午后雨停，资料室灯没熄。胡探守着青铜门缝，王墩守着饭锅，炊烟成了古蜀生活层的旁证。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇五三的生活档案室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别让热饭在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，饭后也要清点工具。", "serious"),
          L("hutan", "罗盘针直颤——二〇五三了，超越期。金声从东北角来，比人间二〇二一还急，连炊烟都像层位线。", "focus"),
          L("yangxue", "第十一日生活日：层位图要按二〇五三标准记。公开资料里的纵目面具，已和营地补给温度重新对齐。", "calm"),
        ...
        assembly: [
          ...
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——今天先别请，回锅肉出锅时胖爷得腾手盛饭。", "grin"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("yangxue", "超越期第十一日：封土层按二〇五三标准记。消除相邻文物，等于震落覆盖的夯土，也要记下饭后回潮。", "calm"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇五三，第十一日生活日。神树残件已定位——此间树高四米，人间论文还在补脚注，营地补给线已经先跑通。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇五三的脉比人间快，脉通了，回营吃饭的路才不乱。", "focus"),
          L("yangxue", "树腰榫眼对上了公开图鉴里的神鸟纹。第 45 层，今日重点记炊烟曲线。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，安全绳不断也算胖爷赢，反正今天先保人也保热汤。", "grin"),
        ],
