...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。三千年前，这里不是「遗址」，是一座活着的城。"),
        L("narrator", "五条探方线路，对应五段被掩埋的记忆。你选的不是关卡，是一段尚未被读出的历史。"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "雨后的探方像一道被揭开的伤疤。湿柴烟没散，第一层陶片下，有金属在呼吸。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，省里批了二十层探方。目标不是「挖宝」，也不是裁判花生归谁，是把层位完整记录下来。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘偏南三度，金声从东北角来。不凶——是有人在等。", "focus"),
          L("yangxue", "我会负责层位图与文物序列。每消除一组同类器物，等于完成一条记录线。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！花生也是后勤物资，得统一保管。", "nervous"),
          L("wangdun", "统一个锤子，那是胖爷的早饭。策划完了就集合，我锅和账都记着呢。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客，谁偷花生谁洗锅。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了，只剩锅盖轻响。地下，有光。", "dramatic"),
        ],
