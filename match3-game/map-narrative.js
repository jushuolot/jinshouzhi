...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跑到二〇四一——古蜀知识迈入超越期。"),
        L("chenli", "今天线索爆发：符号墙的读法反向校勘新坑资料，先按 2041 版谱系标注，再下探方。"),
        L("narrator", "五条探方线路，对应五段被掩埋的记忆。你选的不是关卡，是一段比人间多走了十年的历史。"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，文明历 2041 的符号谱刚合上新坑数据。今天不是普通下坑，是把未来档案倒回第一层。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，遇到回流符号先拍照。", "serious"),
          L("hutan", "罗盘偏南三度，指针像被昨夜雷声拨快——金声从东北角来。不凶，是有人在催我们对答案。", "focus"),
          L("yangxue", "我会负责层位图与文物序列。每消除一组同类器物，等于给超越期谱系补一条证据链。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有给王墩扇风，他一热就说我的金牙反光晃眼。", "nervous"),
          L("wangdun", "胖爷那是保护文物视力！策划完了就集合——刘哥背方便面，这回别泡成考古胶泥。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还拿符号表垫碗。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动层位；二〇四一版谱系刚排好，弄乱我真会生气。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "门缝已开。第二层探方确认：纵目青铜面具，不是装饰，是「神格容器」。", "serious"),
          L("yangxue", "从本章起会出现封土层。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。古蜀人透过它看什么，我们就得先搞清层位。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？通不通我不知道，通坑我肯定行。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "神树残件已定位。树高近四米，我们的探方是它的缩微。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。脉通了，层位才不乱。", "focus"),
          L("yangxue", "树腰有空洞，可能是当年插入真枝的榫眼。第 45 层重点记录。", "calm"),
          L("wangdun", "爬到树顶算胖爷赢，爬不到……也算胖爷赢，反正我尽力。", "grin"),
        ],
        assemblyTitle: "攀树前 · 再集合",
        assembly: [
          L("hutan", "绳索检查完毕。树皮层位滑，跟紧。", "salute"),
          L("yangxue", "我把论文标题都想好了：《神树层位的数字化复原》。", "polite"),
