...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。第八日清晨雾散，文明历已跨入二〇四七——超越期仍在快进。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴和坑内回声又对齐了一轮。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。今天下新坑，先让人像人一样吃口早饭，再让历史往前走。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，第八日新坑批了二十层探方。入口继续轻装上阵——先进图、后立绘，别让雾气拖慢脚步。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，凉馒头也得先放下。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间二〇二一多回了两道音。", "focus"),
          L("yangxue", "今天层位图按二〇四七标准记。公开资料里的纵目面具，已和新坑边缘的铜锈序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有看住王墩，他一早把早饭和样本袋放反了。", "nervous"),
          L("wangdun", "胖爷那叫现场适应！策划完了就集合——刘哥背方便面，我背铲子和醒神茶。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。第八日下新坑，此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还欠一杯热茶。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别把二〇四七的新层位踩成二〇四五的旧脚印。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "第八日的新探方一层一层向下。每一层雾水，都压着一段刚醒的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
