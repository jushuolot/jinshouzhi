...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期，新坑雨水还没干。"),
        L("yangxue", "人间还在消化二〇二一新坑，此间层位图已叠到二〇四七。公开文物图鉴的实拍图，今晚要和坑内编号重新对照。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。第八日下新坑，文明又比人间多走两年。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，省里批了二十层新坑探方。入口继续提速——先进图、后立绘，别在雨棚下干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，文明历按二〇四七走。", "serious"),
          L("hutan", "罗盘针直颤——超越期第八日。金声从东北角来，比人间二〇二一的新坑报告还急半拍。", "focus"),
          L("yangxue", "今天层位图按二〇四七标准记。公开资料里的纵目面具、金杖、陶盉，先和新坑编号对一遍。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有擦图鉴展柜！王墩一早嫌馍素，已经吵两回了。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背新坑第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷火腿，今天还说是文明损耗。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七新坑层位。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，顾问！今天只碰标签，不碰文物。", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是文明历二〇四七刚晾干的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
