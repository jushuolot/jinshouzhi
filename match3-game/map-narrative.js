  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四九。公开文物图鉴、坑内编号和营地口供今晨一起重对。", "calm"),
        L("chenli", "昨夜雨停，资料室灯没熄。今天王墩和金牙刘嗓门都高，古蜀知识却继续跑在人间之前。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇四九的新坑资料室刚把符号二次校读。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四九了，超越期。金声从东北角来，比人间二〇二一还急了两轮，连你俩吵架都压不住。", "focus"),
          L("yangxue", "第九日拌嘴日：层位图要按二〇四九标准记。公开资料里的纵目面具，已和坑内序列完成二次校读。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩说我偷花生，我那叫质量抽检。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背花生账，我背新坑第一铲。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷吃胖爷煎饼。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四九新编号，尤其别用花生袋压标本签。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四九了。纵目面具在公开图鉴里又对过一遍——此间坑内的，比人间档案还新两代。", "serious"),
          L("yangxue", "超越期第九日：封土层按二〇四九标准记。消除相邻文物，等于震落覆盖的夯土；吵架声不计入震源。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四九的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四九了，通不通我不知道，通坑我肯定行——刘哥别又偷吃花生。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("hutan", "连消在风水上叫「通脉」。二〇四九的脉比人间快，脉通了，层位才不乱；嘴仗先放营地。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四九新坑神树层位——此宇宙把拌嘴也写进田野记录》。", "polite"),
