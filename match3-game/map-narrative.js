  ...
  window.MATCH3_MAP = {
    worldIntro: {
      ...
      lines: [
        ...
        L("yangxue", "人间还在整理新坑资料，此间层位图已叠到二〇四九。公开文物图鉴与坑内编号今晨重新对齐，王墩的煎饼油点也被我圈出来了。", "calm"),
        L("chenli", "雨棚滴水，资料室灯没熄。今天又是新的一日——古蜀知识继续跑在人间之前，队里嘴皮子也跟着加速。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        briefing: [
          L("chenli", "诸位，二〇四九的新坑资料室刚开门。省里批了二十层探方，入口已提速——先进图、后立绘，别在营地干等，也别围着一张煎饼开会。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层。", "serious"),
          L("hutan", "罗盘针直颤——二〇四九了，超越期。金声从东北角来，比人间二〇二一还急；刘哥和王墩的嘴仗比罗盘更急。", "focus"),
          L("yangxue", "第九日拌嘴日：层位图要按二〇四九标准记。公开资料里的纵目面具，已和坑内序列重新对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有劝架！王墩把早饭塞进工具包，说这叫补给学，我说这叫证物污染。", "nervous"),
          L("wangdun", "胖爷跟刘哥那是学术辩论！策划完了就集合——刘哥背方便面，我背新坑第一铲，煎饼胖爷先保管。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，今早偷吃胖爷煎饼，文明历二〇四九也得讲理。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四九新编号，尤其别把油纸夹进层位袋。", "polite"),
      ...
      },
      {
        ...
        briefing: [
          ...
          L("yangxue", "超越期第九日：封土层按二〇四九标准记。消除相邻文物，等于震落覆盖的夯土。", "calm"),
          L("hutan", "面具眼窝比人脸宽。二〇四九的罗盘说：古蜀人透过它看的，是还没写进人间论文的东西。", "focus"),
          L("wangdun", "胖爷听说纵目能通神？二〇四九了，通不通我不知道，通坑我肯定行——刘哥别又偷吃煎饼。", "bold"),
      ...
      },
      {
        ...
        briefing: [
          L("chenli", "二〇四九，第九日拌嘴日。神树残件已定位——此间树高四米，人间论文还在补脚注。", "serious"),
          L("hutan", "连消在风水上叫「通脉」。二〇四九的脉比人间快，脉通了，层位才不乱，嘴仗也别乱。", "focus"),
        ...
        assembly: [
          ...
          L("yangxue", "论文标题改了：《二〇四九新坑神树层位与营地拌嘴记录——此宇宙继续快进》。", "polite"),
