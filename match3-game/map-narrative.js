...
(function () {
  ...
  window.MATCH3_MAP = {
    worldIntro: {
      title: "蜀地古蜀文明带",
      lines: [
        L("narrator", "广汉平原，鸭子河南岸。自一九二九年七月首发现起，此间文明历已跨入二〇四七——超越期的第二圈新坑。"),
        L("yangxue", "人间还在整理新坑简报，此间层位图已叠到二〇四七。公开文物图鉴、微距样本和 Commons 档案今晚一起对齐。", "calm"),
        L("chenli", "造物主关屏走了，宇宙没停。第八日开铲，队里有人没睡醒，探方可不会等人。", "serious"),
      ],
    },
    chapters: [
      {
        ...
        mapY: 72,
        landmark: "祭祀坑外营",
        mapBlurb: "雨后的新坑像一道刚揭开的伤疤。第一层陶片下，有金属在呼吸。",
        briefingTitle: "作战策划 · 青铜门启",
        briefing: [
          L("chenli", "诸位，第八日新坑批了二十层探方。入口继续提速——先进图、后立绘，别在营地干等。", "serious"),
          L("chenli", "胡探，你是领队。地下情况不明，按摸金规矩：进坑先观气，动土先记层，微量样本另袋封存。", "serious"),
          L("hutan", "罗盘针直颤——二〇四七了，超越期。金声从东北角来，比人间新坑简报还急半拍。", "focus"),
          L("yangxue", "超越期第八日：层位图按二〇四七标准记。公开资料里的纵目面具，已和坑内微距序列对齐。", "calm"),
          L("jinyaliu", "陈教授，刘哥我负责……后勤！还有叫醒王墩！他一早把刷子当筷子了。", "nervous"),
          L("wangdun", "胖爷那是测试刷毛弹性！策划完了就集合——刘哥背方便面，别背估价表。", "bold"),
        ],
        assemblyTitle: "小队集合 · 下坑前",
        assembly: [
          L("hutan", "胡探，摸金校尉。此行只归档，不私携。", "salute"),
          L("wangdun", "王墩，扛包开路。谁怕鬼谁请客——刘哥你请，昨晚偷吃胖爷新坑夜宵。", "grin"),
          L("yangxue", "杨雪，哈佛考古系。请多关照，也请各位别乱动二〇四七样本袋。", "polite"),
          L("jinyaliu", "金牙刘，……官方顾问。咳，今天只顾问，不估价！", "sheepish"),
          L("chenli", "陈礼，省考古队。二十层之后，若见青铜门——停步，等我。", "warn"),
          L("narrator", "五人影没入探方。风停了。地下，有光。", "dramatic"),
        ],
        routeIntro: "新坑一层一层向下。每一层都是一段刚醒来的时间。",
        milestones: {
          1: "营地入坑",
          4: "陶片层",
          8: "象牙露头",
