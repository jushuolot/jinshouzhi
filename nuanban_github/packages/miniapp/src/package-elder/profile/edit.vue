<template>
  <view class="page" :class="elderFontCls">
    ...
    <text class="field-hint">{{ orgSectionHint }}</text>

    <text class="readonly-label">所属机构</text>
    <view class="readonly nb-input">{{ orgName || orgEmptyLabel }}</view>

    <text class="readonly-label">所在区域</text>
    <view class="readonly nb-input">{{ district || orgEmptyLabel }}</view>

    <text class="readonly-label">健康概况</text>
    <view class="readonly nb-input">{{ healthStatus || orgEmptyLabel }}</view>

    <text class="readonly-label">行动能力</text>
    <view class="readonly nb-input">{{ mobility || orgEmptyLabel }}</view>
...
import { ELDER_ORG_EMPTY_LABEL, ELDER_ORG_PROFILE_HINT } from '../../utils/elder-org-profile';
...
const orgSectionHint = ELDER_ORG_PROFILE_HINT;
const orgEmptyLabel = ELDER_ORG_EMPTY_LABEL;
