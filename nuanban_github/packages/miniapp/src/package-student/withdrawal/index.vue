  ...
  <view class="page nb-page">
    ...
    <view class="channel-card nb-card">
      ...
      >
        ...
        <text class="channel-meta">{{ overview?.boundWechat || '演示绑定' }}</text>
      </view>
      <view
        class="channel-item"
      ...
      >
        ...
        <text class="channel-meta">{{ overview?.boundBank || '演示绑定' }}</text>
      </view>
    </view>
    ...
    <view class="amount-card nb-card">
      ...
      <text class="hint">演示环境，微信即时到账；银行卡 1–3 工作日（mock）</text>
    </view>
