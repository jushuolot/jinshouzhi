...
export const MODULE_GROUPS: ModuleGroup[] = [
  {
    ...
    color: '#c45c26',
    entries: [
      { id: 'elder-home', title: '首页', desc: '订单概览 · 储值卡 · 快捷服务', icon: '🏠', path: '/package-elder/home', account: '13800000005' },
  ...
  },
  {
    ...
    color: '#2e7d6e',
    entries: [
      { id: 'family-home', title: '家属中心', desc: '待办 · 动态 · 绑定', icon: '🏡', path: '/package-family/home', account: '13800000004' },
  ...
  },
  {
    ...
    color: '#5c6bc0',
    entries: [
      { id: 'student-home', title: '学生首页', desc: '待接 · 收入 · 提现', icon: '🎓', path: '/package-student/home', account: '13800000001' },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'admin', title: '运营演示', desc: 'KPI · 动态 · 派单', icon: '📊', path: '/pages/common/admin-hub' },
