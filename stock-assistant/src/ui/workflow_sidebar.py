...
*进化路线见仓库 `EVOLUTION.md`*
        ...
        phase = st.selectbox(
            "当前进化阶段",
            ["P1 结构+可读资料", "P2 页面模块化", "P3 一键分析", "P4 公网协作", "P5 智能持久化", "P6 体验极限", "P7 智能增强", "P8 生态扩展", "P9 运维观测", "P10 导出增强", "P11 文档版本", "P12 百步进化", "P13 智能提醒", "P14 运维脚本", "P15 体验抛光", "P16 双股对比", "P17 提醒推送", "P18 体验与v2"],
            index=17,
            disabled=True,
        )
        st.caption(phase)
